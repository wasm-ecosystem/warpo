(module
 ...
 (data $13.1 (i32.const 680) "\02\00\00\00\1a\00\00\00H\00e\00l\00l\00o\00,\00 \00W\00o\00r\00l\00d\00!\00\00\00<")
 (data $14.1 (i32.const 728) "\02\00\00\00(\00\00\00c\00o\00m\00p\00u\00t\00e\00d\00-\00p\00r\00o\00p\00e\00r\00t\00y\00.\00t\00s")
 (data $15 (i32.const 784) "\0b\00\00\00 \00\00\00 \00\00\00 \00\00\00\00\00\00\00\10\01\82\00\00\00\00\00 \00\00\00\10A\02\00 \00\00\00 \00\00\00 ")
 ...
 (func $~lib/rt/itcms/__new (param $0 i32) (param $1 i32) (result i32)
  ...
  if
   block $__inlined_func$~lib/rt/itcms/interrupt$67
    ...
    loop $do-loop|0
     local.get $2
     block $__inlined_func$~lib/rt/itcms/step$167 (result i32)
      block $break|0
       block $case2|0
        block $case1|0
         block $case0|0
         ...
         global.set $~lib/rt/itcms/iter
         global.get $~lib/rt/itcms/visitCount
         br $__inlined_func$~lib/rt/itcms/step$167
        end
        global.get $~lib/rt/itcms/white
        i32.eqz
        local.set $4
     ...
     block $~lib/tuple/SmallTuple
      block $"~lib/map/Map<~lib/string/String,usize>"
       block $~lib/arraybuffer/ArrayBufferView
        ...
        i32.sub
        i32.load
        br_table $computed-property/ComputedPropertyFn $computed-property/ComputedPropertyFn $computed-property/ComputedPropertyFn $~lib/arraybuffer/ArrayBufferView $"~lib/map/Map<~lib/string/String,usize>" $~lib/tuple/SmallTuple $computed-property/ComputedPropertyFn $"~lib/map/Map<usize,~lib/string/String>" $computed-property/ComputedPropertyFn $computed-property/ComputedPropertyFn $computed-property/ComputedPropertyFn $invalid
       end
       local.get $0
       i32.load
       call $~lib/rt/itcms/__visit
 ...
 (func $~start
  ...
  block $__inlined_func$~lib/symbol/Symbol.for$187 (result i32)
   global.get $~lib/symbol/stringToId
   i32.const 32
   ...
   if
    ...
    local.get $0
    i32.load offset=4
    br $__inlined_func$~lib/symbol/Symbol.for$187
   end
   ...
   block $"__inlined_func$~lib/map/Map<usize,~lib/string/String>#find$169" (result i32)
    global.get $~lib/symbol/idToString
    local.tee $1
    i32.load
    local.get $7
    ...
    loop $while-continue|00
     ...
     if
      ...
      br_if $"__inlined_func$~lib/map/Map<usize,~lib/string/String>#find$169"
      drop
      local.get $2
      i32.const -2
      i32.and
