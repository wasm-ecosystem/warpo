(module
 ...
 (data $8 (i32.const 416) "\04\00\00\00 \00\00\00 \00\00\00 ")
  ...
  block $invalid
   ...
   if
    ...
    if
     ...
     block $__inlined_func$~lib/rt/itcms/Object#unlink$73
      local.get $0
      i32.load offset=4
      i32.const -4
      i32.and
      ...
      if
       ...
       br $__inlined_func$~lib/rt/itcms/Object#unlink$73
      end
      local.get $0
      i32.load offset=8
      local.tee $1
 ...
 (func $~start
  ...
  if
   block $__inlined_func$~lib/rt/itcms/interrupt$66
    ...
    loop $do-loop|0
     local.get $0
     block $__inlined_func$~lib/rt/itcms/step$78 (result i32)
      block $break|0
       block $case2|0
        block $case1|0
         block $case0|0
         ...
         global.set $~lib/rt/itcms/iter
         global.get $~lib/rt/itcms/visitCount
         br $__inlined_func$~lib/rt/itcms/step$78
        end
        global.get $~lib/rt/itcms/white
        i32.eqz
        local.set $1
