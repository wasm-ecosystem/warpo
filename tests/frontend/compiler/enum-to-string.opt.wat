(module
 ...
 (func $enum-to-string/Enum#__enum_to_string (param $0 i32) (result i32)
  block $~CONDITION_RETURN/enum-to-string/Enum#__enum_to_string (result i32)
   i32.const 32
   local.get $0
   i32.const 2
   i32.eq
   br_if $~CONDITION_RETURN/enum-to-string/Enum#__enum_to_string
   drop
   i32.const 64
   local.get $0
   i32.const 1
 ...
 (func $enum-to-string/InlineEnum#__enum_to_string (param $0 i32) (result i32)
  block $~CONDITION_RETURN/enum-to-string/InlineEnum#__enum_to_string (result i32)
   i32.const 192
   local.get $0
   i32.const 2
   i32.eq
   br_if $~CONDITION_RETURN/enum-to-string/InlineEnum#__enum_to_string
   drop
   i32.const 224
   local.get $0
   i32.const 1
 ...
 (func $enum-to-string/EnumWithInit#__enum_to_string (param $0 i32) (result i32)
  block $~CONDITION_RETURN/enum-to-string/EnumWithInit#__enum_to_string (result i32)
   i32.const 32
   local.get $0
   i32.const 4
   i32.eq
   br_if $~CONDITION_RETURN/enum-to-string/EnumWithInit#__enum_to_string
   drop
   i32.const 64
   local.get $0
   i32.const 2
