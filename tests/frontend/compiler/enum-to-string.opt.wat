(module
 ...
 (func $enum-to-string/EnumWithInit#__enum_to_string (param $0 i32) (result i32)
  block $__inlined_func$byn$mgfn-shared$enum-to-string/EnumWithInit#__enum_to_string$7 (result i32)
   i32.const 32
   local.get $0
   i32.const 4
   i32.eq
   br_if $__inlined_func$byn$mgfn-shared$enum-to-string/EnumWithInit#__enum_to_string$7
   drop
   i32.const 64
   local.get $0
   i32.const 2
 ...
 (func $enum-to-string/EnumWithDup#__enum_to_string (param $0 i32) (result i32)
  (local $1 i32)
  block $__inlined_func$byn$mgfn-shared$enum-to-string/EnumWithInit#__enum_to_string$8 (result i32)
   i32.const 32
   local.get $0
   i32.const 1
   i32.eq
   local.tee $1
   br_if $__inlined_func$byn$mgfn-shared$enum-to-string/EnumWithInit#__enum_to_string$8
   drop
   i32.const 64
   local.get $0
   i32.const 2
