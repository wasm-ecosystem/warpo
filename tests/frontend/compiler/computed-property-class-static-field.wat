(module
 ...
 (global $computed-property-class-static-field/computed_property_class_static_field.SymbolWrapper.symbol (mut i32) (i32.const 0))
 ...
 (data $14 (i32.const 716) "l\00\00\00\00\00\00\00\00\00\00\00\02\00\00\00N\00\00\00c\00o\00m\00p\00u\00t\00e\00d\00-\00p\00r\00o\00p\00e\00r\00t\00y\00-\00c\00l\00a\00s\00s\00-\00s\00t\00a\00t\00i\00c\00-\00f\00i\00e\00l\00d\00.\00t\00s\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00")
 (data $15 (i32.const 832) "\08\00\00\00 \00\00\00 \00\00\00 \00\00\00\00\00\00\00\10\01\82\00\00\00\00\00\10A\02\00 \00\00\00")
 (table $0 1 1 funcref)
 (elem $0 (i32.const 1))
 ...
 (func $computed-property-class-static-field/computed_property_class_static_field.Fn#constructor (param $this i32) (result i32)
  (local.set $this
   (call $~lib/rt/__localtostack
 ...
 (func $"computed-property-class-static-field/computed_property_class_static_field.IFn#[computed-property-class-static-field/computed_property_class_static_field.SymbolWrapper.symbol]" (param $this i32) (result i32)
  (unreachable)
 )
 (func $computed-property-class-static-field/computed_property_class_static_field.test
  (local $myfn i32)
  (local.set $myfn
   (call $~lib/rt/__localtostack
    (call $computed-property-class-static-field/computed_property_class_static_field.Fn#constructor
     (call $~lib/rt/__tmptostack
      (call $~lib/rt/itcms/__new
       (i32.const 0)
       (i32.const 7)
  ...
  (if
   (i32.eqz
    (call $~lib/string/String.__eq
     (call $~lib/rt/__tmptostack
      (call $"computed-property-class-static-field/computed_property_class_static_field.IFn#[computed-property-class-static-field/computed_property_class_static_field.SymbolWrapper.symbol]@override"
       (call $~lib/rt/__tmptostack
        (local.get $myfn)
       )
      )
 ...
 (func $start:computed-property-class-static-field
  (global.set $~lib/rt/itcms/threshold
   (i32.shr_u
    (i32.sub
     (i32.shl
  ...
  (global.set $computed-property-class-static-field/computed_property_class_static_field.SymbolWrapper.symbol
   (call $~lib/symbol/Symbol.for
    (i32.const 32)
   )
  )
  (call $computed-property-class-static-field/computed_property_class_static_field.test)
 )
 (func $"computed-property-class-static-field/computed_property_class_static_field.Fn#[computed-property-class-static-field/computed_property_class_static_field.SymbolWrapper.symbol]" (param $this i32) (result i32)
  (return
   (i32.const 688)
  )
 )
 (func $"computed-property-class-static-field/computed_property_class_static_field.IFn#[computed-property-class-static-field/computed_property_class_static_field.SymbolWrapper.symbol]@override" (param $0 i32) (result i32)
  (local $1 i32)
  (block $default
   (block $case0
    (local.set $1
   ...
   (return
    (call $"computed-property-class-static-field/computed_property_class_static_field.Fn#[computed-property-class-static-field/computed_property_class_static_field.SymbolWrapper.symbol]"
     (local.get $0)
    )
   )
  )
        ...
        (block $~lib/string/String
         (block $~lib/arraybuffer/ArrayBuffer
          (block $~lib/object/Object
           (br_table $~lib/object/Object $~lib/arraybuffer/ArrayBuffer $~lib/string/String $~lib/arraybuffer/ArrayBufferView $"~lib/map/Map<~lib/string/String,usize>" $~lib/tuple/SmallTuple $"~lib/map/Map<usize,~lib/string/String>" $computed-property-class-static-field/computed_property_class_static_field.Fn $invalid
            (i32.load
             (i32.sub
              (local.get $0)
              (i32.const 8)
 ...
 (func $~start
  (call $start:computed-property-class-static-field)
 )
)
