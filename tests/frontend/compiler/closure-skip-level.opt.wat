(module
 ...
 (data $8.1 (i32.const 424) "\02\00\00\00*\00\00\00c\00l\00o\00s\00u\00r\00e\00-\00s\00k\00i\00p\00-\00l\00e\00v\00e\00l\00.\00t\00s")
 ...
 (func $closure-skip-level/outer~middle~inner (result i32)
  (local $0 i32)
  i32.const 12
  i32.const 4
 ...
 (func $closure-skip-level/outer~middle (result i32)
  (local $0 i32)
  (local $1 i32)
  i32.const 12
  i32.const 4
 ...
 (func $closure-skip-level/outer (param $0 i32) (result i32)
  (local $1 i32)
  i32.const 16
  i32.const 4
  call $~lib/rt/itcms/__new
