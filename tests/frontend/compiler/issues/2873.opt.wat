(module
 ...
 (data $17.1 (i32.const 1960) "\02\00\00\00\06\00\00\001\00.\001")
 (data $18 (i32.const 1980) ",")
 (data $18.1 (i32.const 1992) "\02\00\00\00\1c\00\00\00i\00s\00s\00u\00e\00s\00/\002\008\007\003\00.\00t\00s\00\1c")
 (data $19.1 (i32.const 2040) "\01\00\00\00\0c\00\00\00\cd\cc\8c?\cd\cc\0c@33S@,")
 (data $20.1 (i32.const 2072) "\04\00\00\00\10\00\00\00\00\08\00\00\00\08\00\00\0c\00\00\00\03")
 (data $21 (i32.const 2108) "\1c")
 (data $21.1 (i32.const 2120) "\02")
 (data $22 (i32.const 2140) "\1c")
 (data $22.1 (i32.const 2152) "\02\00\00\00\02\00\00\00,")
 (data $23 (i32.const 2172) ",")
 (data $23.1 (i32.const 2184) "\02\00\00\00\16\00\00\001\00.\001\00,\002\00.\002\00,\003\00.\003")
 (data $24 (i32.const 2220) ",")
 (data $24.1 (i32.const 2232) "\01\00\00\00\18\00\00\00\9a\99\99\99\99\99\f1?\9a\99\99\99\99\99\01@ffffff\n@\00\00\00\00,")
 (data $25.1 (i32.const 2280) "\06\00\00\00\10\00\00\00\c0\08\00\00\c0\08\00\00\18\00\00\00\03")
 (data $26 (i32.const 2320) "\08\00\00\00 \00\00\00 \00\00\00 \00\00\00\00\00\00\00\02\19\00\00 \00\00\00\02\1a\00\00 ")
 ...
 (func $~lib/util/number/dtoa_core (param $0 i32) (param $1 f64) (param $2 i32) (result i32)
  ...
  i64.sub
  local.set $5
  block $__inlined_func$~lib/util/number/prettify$1 (result i32)
   local.get $0
   local.get $13
   i32.const 1
   i32.shl
   ...
   i64.add
   local.set $9
   block $__inlined_func$~lib/util/number/genDigits (result i32)
    local.get $0
    local.set $10
    local.get $5
    local.get $7
    ...
    loop $while-continue|0
     ...
     if
      ...
      if
       ...
       i32.store16
       local.get $0
       br $__inlined_func$~lib/util/number/genDigits
      end
      br $while-continue|0
     end
    end
   ...
   if
    ...
    i32.const 2
    i32.add
    br $__inlined_func$~lib/util/number/prettify$1
   end
   local.get $0
   local.get $3
   i32.add
  ...
  block $folding-inner0
   block $invalid
    block $~lib/iterator/Iterable<f64>
     ...
     i32.sub
     i32.load
     br_table $~lib/iterator/Iterable<f64> $~lib/iterator/Iterable<f64> $~lib/iterator/Iterable<f64> $folding-inner0 $folding-inner0 $~lib/iterator/Iterable<f64> $folding-inner0 $~lib/iterator/Iterable<f64> $invalid
    end
    return
   end
   unreachable
