(module
 ...
 (data $25.1 (i32.const 2280) "\05\00\00\00\10\00\00\00\c0\08\00\00\c0\08\00\00\18\00\00\00\03")
 (data $26 (i32.const 2320) "\06\00\00\00 \00\00\00 \00\00\00 \00\00\00\00\00\00\00\02\19\00\00\02\1a")
 ...
 (func $~start
  ...
  i32.load
  local.set $0
  block $~CONDITION_RETURN/~lib/util/string/joinFloatArray<f32> (result i32)
   global.get $~lib/memory/__stack_pointer
   i32.const 4
   i32.sub
   ...
   i32.const 0
   i32.lt_s
   br_if $~CONDITION_RETURN/~lib/util/string/joinFloatArray<f32>
   drop
   local.get $2
   i32.eqz
   if
    ...
    f32.load
    call $~lib/util/number/dtoa<f32>
    br $~CONDITION_RETURN/~lib/util/string/joinFloatArray<f32>
   end
   i32.const 2156
   i32.load
   i32.const 1
