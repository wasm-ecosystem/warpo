  ...
  block $folding-inner0
   block $invalid
    block $~lib/iterator/Iterable<i32>
     ...
     i32.sub
     i32.load
     br_table $~lib/iterator/Iterable<i32> $~lib/iterator/Iterable<i32> $~lib/iterator/Iterable<i32> $folding-inner0 $folding-inner0 $folding-inner0 $~lib/iterator/Iterable<i32> $invalid
    end
    return
   end
   unreachable
