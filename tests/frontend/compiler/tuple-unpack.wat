(module
 ...
 (global $tuple-unpack/makePairCalls (mut i32) (i32.const 0))
 ...
 (data $8 (i32.const 412) "\1c\00\00\00\00\00\00\00\00\00\00\00\02\00\00\00\n\00\00\00t\00u\00p\00l\00e\00\00\00")
 (data $9 (i32.const 444) "<\00\00\00\00\00\00\00\00\00\00\00\02\00\00\00\1e\00\00\00t\00u\00p\00l\00e\00-\00u\00n\00p\00a\00c\00k\00.\00t\00s\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00")
 (data $10 (i32.const 512) "\05\00\00\00 \00\00\00 \00\00\00 \00\00\00\00\00\00\00\00\00\00\00")
 (table $0 1 1 funcref)
 (elem $0 (i32.const 1))
 (export "_start" (func $tuple-unpack/_start))
 ...
 (func $tuple-unpack/makePair (param $value i32) (result i32)
  (local $1 i32)
  (global.set $tuple-unpack/makePairCalls
   (i32.add
    (global.get $tuple-unpack/makePairCalls)
    (i32.const 1)
   )
  )
  (return
 ...
 (func $tuple-unpack/_start (result i32)
  (local $0 i32)
  (local $value i32)
  (local $text i32)
  (local.set $0
   (call $~lib/rt/__localtostack
    (call $tuple-unpack/makePair
     (i32.const 10)
    )
   )
  )
