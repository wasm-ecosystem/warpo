(module
 ...
 (global $unused-field-store-nontrivial/packet (mut i32) (i32.const 0))
 ...
 (data $8 (i32.const 412) "\\\00\00\00\00\00\00\00\00\00\00\00\02\00\00\00@\00\00\00u\00n\00u\00s\00e\00d\00-\00f\00i\00e\00l\00d\00-\00s\00t\00o\00r\00e\00-\00n\00o\00n\00t\00r\00i\00v\00i\00a\00l\00.\00t\00s\00\00\00\00\00\00\00\00\00\00\00\00\00")
 ...
 (func $unused-field-store-nontrivial/Packet#constructor (param $this i32) (result i32)
  (local.set $this
 ...
 (func $unused-field-store-nontrivial/Packet#set:value_ (param $this i32) (param $value_ i32)
  (i32.store
   (local.get $this)
   (local.get $value_)
  )
 )
 (func $unused-field-store-nontrivial/Packet#get:writeCount_ (param $this i32) (result i32)
  (i32.load offset=4
   (local.get $this)
  )
 )
 (func $unused-field-store-nontrivial/Packet#set:writeCount_ (param $this i32) (param $writeCount_ i32)
  (i32.store offset=4
   (local.get $this)
   (local.get $writeCount_)
  )
 )
 (func $unused-field-store-nontrivial/Packet#set:value (param $this i32) (param $value i32)
  (call $unused-field-store-nontrivial/Packet#set:value_
   (call $~lib/rt/__tmptostack
    (local.get $this)
   )
   (local.get $value)
  )
  (call $unused-field-store-nontrivial/Packet#set:writeCount_
   (call $~lib/rt/__tmptostack
    (local.get $this)
   )
   (i32.add
    (call $unused-field-store-nontrivial/Packet#get:writeCount_
     (call $~lib/rt/__tmptostack
      (local.get $this)
     )
    )
 ...
 (func $unused-field-store-nontrivial/writeValue (param $packet i32)
  (call $unused-field-store-nontrivial/Packet#set:value
   (call $~lib/rt/__tmptostack
    (local.get $packet)
   )
   (i32.const 1)
 ...
 (func $unused-field-store-nontrivial/Packet#get:writeCount (param $this i32) (result i32)
  (return
   (call $unused-field-store-nontrivial/Packet#get:writeCount_
    (call $~lib/rt/__tmptostack
     (local.get $this)
 ...
 (func $unused-field-store-nontrivial/getWriteCount (param $packet i32) (result i32)
  (return
   (call $unused-field-store-nontrivial/Packet#get:writeCount
    (call $~lib/rt/__tmptostack
     (local.get $packet)
    )
   )
 ...
 (func $start:unused-field-store-nontrivial
  (global.set $~lib/rt/itcms/threshold
   (i32.shr_u
    (i32.sub
     (i32.shl
  ...
  (global.set $unused-field-store-nontrivial/packet
   (call $unused-field-store-nontrivial/Packet#constructor
    (call $~lib/rt/__tmptostack
  ...
  (call $unused-field-store-nontrivial/writeValue
   (call $~lib/rt/__tmptostack
  ...
  (if
   (i32.eqz
    (i32.eq
     (call $unused-field-store-nontrivial/getWriteCount
      (call $~lib/rt/__tmptostack
       (global.get $unused-field-store-nontrivial/packet)
      )
     )
 ...
 (func $~lib/rt/__visit_members (param $0 i32) (param $1 i32)
  (block $invalid
   (block $unused-field-store-nontrivial/Packet
    (block $~lib/arraybuffer/ArrayBufferView
     (block $~lib/string/String
      (block $~lib/arraybuffer/ArrayBuffer
       (block $~lib/object/Object
        (br_table $~lib/object/Object $~lib/arraybuffer/ArrayBuffer $~lib/string/String $~lib/arraybuffer/ArrayBufferView $unused-field-store-nontrivial/Packet $invalid
         (i32.load
          (i32.sub
           (local.get $0)
           (i32.const 8)
 ...
 (func $~start
  (call $start:unused-field-store-nontrivial)
 )
)
