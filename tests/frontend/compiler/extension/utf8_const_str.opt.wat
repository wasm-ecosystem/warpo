(module
 ...
 (data $2.1 (i32.const 136) "\02\00\00\00\1c\00\00\00~\00l\00i\00b\00/\00s\00t\00r\00i\00n\00g\00.\00t\00s\00<")
 (data $3.1 (i32.const 184) "\02\00\00\00(\00\00\00A\00l\00l\00o\00c\00a\00t\00i\00o\00n\00 \00t\00o\00o\00 \00l\00a\00r\00g\00e\00\00\00\00\00<")
 ...
 (data $11.1 (i32.const 584) "\02\00\00\00\0c\00\00\00a\00b\00c\00d\00e\00f\00\00\00\00\00\04\00\00\00 \00\00\00 \00\00\00 ")
 ...
 (func $~start
  ...
  i32.const 480
  global.set $~lib/rt/itcms/fromSpace
  block $__inlined_func$~lib/string/String.__eq$91 (result i32)
   i32.const 32
   local.tee $0
   i32.const 28
   i32.load
   ...
   i32.const 1
   block $__inlined_func$~lib/rt/itcms/__renew$89 (result i32)
    local.get $5
    local.get $3
    i32.sub
    local.tee $4
    ...
    if
     ...
     i32.store offset=16
     local.get $3
     br $__inlined_func$~lib/rt/itcms/__renew$89
    end
    local.get $4
    local.get $2
    i32.load offset=12
   ...
   i32.const 592
   i32.eq
   br_if $__inlined_func$~lib/string/String.__eq$91
   drop
   i32.const 0
   local.get $1
   i32.eqz
