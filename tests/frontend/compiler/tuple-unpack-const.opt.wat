(module
 ...
 (data $8.1 (i32.const 424) "\02\00\00\00*\00\00\00t\00u\00p\00l\00e\00-\00u\00n\00p\00a\00c\00k\00-\00c\00o\00n\00s\00t\00.\00t\00s")
 (data $9 (i32.const 480) "\06\00\00\00 \00\00\00 \00\00\00 ")
 (data $9.1 (i32.const 504) " ")
   ...
   block $tuple-unpack-const/Box
    block $~lib/tuple/SmallTuple
     block $~lib/arraybuffer/ArrayBufferView
      ...
      i32.sub
      i32.load
      br_table $tuple-unpack-const/Box $tuple-unpack-const/Box $tuple-unpack-const/Box $~lib/arraybuffer/ArrayBufferView $~lib/tuple/SmallTuple $tuple-unpack-const/Box $invalid
     end
     local.get $0
     i32.load
