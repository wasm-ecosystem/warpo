(module
 ...
 (global $unused-field-store-side-effect/state (mut i32) (i32.const 0))
 ...
 (data $8 (i32.const 412) "\\\00\00\00\00\00\00\00\00\00\00\00\02\00\00\00B\00\00\00u\00n\00u\00s\00e\00d\00-\00f\00i\00e\00l\00d\00-\00s\00t\00o\00r\00e\00-\00s\00i\00d\00e\00-\00e\00f\00f\00e\00c\00t\00.\00t\00s\00\00\00\00\00\00\00\00\00\00\00")
 ...
 (func $unused-field-store-side-effect/Packet#constructor (param $this i32) (result i32)
  (local.set $this
 ...
 (func $unused-field-store-side-effect/sideEffect (result i32)
  (global.set $unused-field-store-side-effect/state
   (i32.add
    (global.get $unused-field-store-side-effect/state)
    (i32.const 1)
   )
  )
  (return
 ...
 (func $unused-field-store-side-effect/Packet#set:unused (param $this i32) (param $unused i32)
  (i32.store
   (local.get $this)
   (local.get $unused)
  )
 )
 (func $unused-field-store-side-effect/write (param $packet i32)
  (call $unused-field-store-side-effect/Packet#set:unused
   (call $~lib/rt/__tmptostack
    (local.get $packet)
   )
   (call $unused-field-store-side-effect/sideEffect)
  )
 )
 (func $start:unused-field-store-side-effect
  (global.set $~lib/rt/itcms/threshold
   (i32.shr_u
    (i32.sub
     (i32.shl
  ...
  (call $unused-field-store-side-effect/write
   (call $~lib/rt/__tmptostack
    (call $unused-field-store-side-effect/Packet#constructor
     (call $~lib/rt/__tmptostack
 ...
 (func $~lib/rt/__visit_members (param $0 i32) (param $1 i32)
  (block $invalid
   (block $unused-field-store-side-effect/Packet
    (block $~lib/arraybuffer/ArrayBufferView
     (block $~lib/string/String
      (block $~lib/arraybuffer/ArrayBuffer
       (block $~lib/object/Object
        (br_table $~lib/object/Object $~lib/arraybuffer/ArrayBuffer $~lib/string/String $~lib/arraybuffer/ArrayBufferView $unused-field-store-side-effect/Packet $invalid
         (i32.load
          (i32.sub
           (local.get $0)
           (i32.const 8)
 ...
 (func $~start
  (call $start:unused-field-store-side-effect)
 )
)
