(module
 ...
 (global $closure-capture-variable-in-loop-upper-level/func1 (mut i32) (i32.const 0))
 (global $closure-capture-variable-in-loop-upper-level/func2 (mut i32) (i32.const 0))
 ...
 (data $8.1 (i32.const 424) "\02\00\00\00^\00\00\00c\00l\00o\00s\00u\00r\00e\00-\00c\00a\00p\00t\00u\00r\00e\00-\00v\00a\00r\00i\00a\00b\00l\00e\00-\00i\00n\00-\00l\00o\00o\00p\00-\00u\00p\00p\00e\00r\00-\00l\00e\00v\00e\00l\00.\00t\00s")
 (data $9 (i32.const 540) "|")
 (data $9.1 (i32.const 552) "\02\00\00\00^\00\00\00U\00n\00e\00x\00p\00e\00c\00t\00e\00d\00 \00\'\00n\00u\00l\00l\00\'\00 \00(\00n\00o\00t\00 \00a\00s\00s\00i\00g\00n\00e\00d\00 \00o\00r\00 \00f\00a\00i\00l\00e\00d\00 \00c\00a\00s\00t\00)")
 (data $10 (i32.const 672) "\06\00\00\00 \00\00\00 \00\00\00 ")
 (table $0 2 2 funcref)
 (elem $0 (i32.const 1) $closure-capture-variable-in-loop-upper-level/outer~inner)
 (export "outer" (func $closure-capture-variable-in-loop-upper-level/outer))
 ...
 (func $closure-capture-variable-in-loop-upper-level/outer~inner (result i32)
  (local $0 i32)
  i32.const 12
  i32.const 4
 ...
 (func $closure-capture-variable-in-loop-upper-level/outer (result i32)
  (local $0 i32)
  (local $1 i32)
  (local $2 i32)
  (local $3 i32)
  ...
  loop $for-loop|0
   ...
   if
    ...
    if
     local.get $0
     global.set $closure-capture-variable-in-loop-upper-level/func2
    else
     local.get $0
     global.set $closure-capture-variable-in-loop-upper-level/func1
    end
    local.get $1
    i32.const 1
    i32.add
 ...
 (func $~start
  ...
  call $closure-capture-variable-in-loop-upper-level/outer
  i32.const 100
  i32.ne
  if
   i32.const 0
  ...
  global.get $closure-capture-variable-in-loop-upper-level/func1
  i32.eqz
  if
   i32.const 0
   i32.const 432
  ...
  global.get $closure-capture-variable-in-loop-upper-level/func2
  i32.eqz
  if
   i32.const 0
   i32.const 432
