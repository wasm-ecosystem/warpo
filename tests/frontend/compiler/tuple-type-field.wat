(module
 ...
 (global $tuple-type-field/disableScriptMode i32 (i32.const 1))
 ...
 (global $tuple-type-field/a (mut i32) (i32.const 0))
 ...
 (data $9 (i32.const 444) "<\00\00\00\00\00\00\00\00\00\00\00\02\00\00\00&\00\00\00t\00u\00p\00l\00e\00-\00t\00y\00p\00e\00-\00f\00i\00e\00l\00d\00.\00t\00s\00\00\00\00\00\00\00")
 (data $10 (i32.const 512) "\06\00\00\00 \00\00\00 \00\00\00 \00\00\00\00\00\00\00\00\00\00\00\00\00\00\00")
 (table $0 1 1 funcref)
 (elem $0 (i32.const 1))
 (export "disableScriptMode" (global $tuple-type-field/disableScriptMode))
 ...
 (func $tuple-type-field/A#set:field (param $this i32) (param $field i32)
  (i32.store
   (local.get $this)
   (local.get $field)
  )
 ...
 (func $tuple-type-field/A#get:field (param $this i32) (result i32)
  (i32.load
   (local.get $this)
  )
 )
   ...
   (i32.eqz
    (i32.eq
     (call $~lib/tuple/SmallTuple#__get<i32>
      (call $~lib/rt/__tmptostack
       (call $tuple-type-field/A#get:field
        (call $~lib/rt/__tmptostack
 ...
 (func $tuple-type-field/A~visit (param $0 i32) (param $1 i32)
  (local $2 i32)
  (call $~lib/object/Object~visit
   (local.get $0)
   (local.get $1)
