(module
 ...
 (data $8 (i32.const 412) "\1c\00\00\00\00\00\00\00\00\00\00\00\05\00\00\00\08\00\00\00\03\00\00\00\00\00\00\00\00\00\00\00")
 (data $9 (i32.const 444) "\\\00\00\00\00\00\00\00\00\00\00\00\02\00\00\00F\00\00\00c\00l\00o\00s\00u\00r\00e\00-\00c\00a\00p\00t\00u\00r\00e\00d\00-\00f\00r\00o\00m\00-\00n\00o\00n\00c\00l\00o\00s\00u\00r\00e\00.\00t\00s\00\00\00\00\00\00\00")
 (data $10 (i32.const 544) "\07\00\00\00 \00\00\00 \00\00\00 \00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00")
 (table $0 4 4 funcref)
 (elem $0 (i32.const 1) $closure-captured-from-nonclosure/test~anonymous|0~anonymous|0 $closure-captured-from-nonclosure/test~anonymous|0 $closure-captured-from-nonclosure/call~anonymous|0)
 (export "test" (func $closure-captured-from-nonclosure/test))
 (export "memory" (memory $0))
 (start $~start)
 (func $~lib/tuple/SmallTuple#__get<%28%29=>i32> (param $this i32) (param $offset i32) (result i32)
 ...
 (func $closure-captured-from-nonclosure/test~anonymous|0~anonymous|0 (result i32)
  (local $0 i32)
  (local $1 i32)
  (local.set $0
 ...
 (func $~lib/tuple/SmallTuple#__set<%28%29=>i32> (param $this i32) (param $offset i32) (param $value i32)
  (local $elementPtr i32)
  (local.set $elementPtr
   (i32.add
    (local.get $this)
 ...
 (func $closure-captured-from-nonclosure/test~anonymous|0 (param $resolve i32) (result i32)
  (local $1 i32)
  (local $inner i32)
  (local.set $1
   (call $~lib/rt/__localtostack
 ...
 (func $closure-captured-from-nonclosure/call~anonymous|0 (result i32)
  (i32.const 42)
 )
 (func $closure-captured-from-nonclosure/call (param $fn i32) (result i32)
  (return
 ...
 (func $closure-captured-from-nonclosure/test (result i32)
  (return
   (call $closure-captured-from-nonclosure/call
    (call $~lib/rt/__tmptostack
     (call $~lib/rt/__newFunction
      (i32.const 2)
      (i32.const 0)
 ...
 (func $start:closure-captured-from-nonclosure
  (global.set $~lib/rt/itcms/threshold
   (i32.shr_u
    (i32.sub
     (i32.shl
  ...
  (if
   (i32.eqz
    (i32.eq
     (call $closure-captured-from-nonclosure/test)
     (i32.const 42)
    )
   )
   (then
       ...
       (block $~lib/string/String
        (block $~lib/arraybuffer/ArrayBuffer
         (block $~lib/object/Object
          (br_table $~lib/object/Object $~lib/arraybuffer/ArrayBuffer $~lib/string/String $~lib/arraybuffer/ArrayBufferView $~lib/tuple/SmallTuple $~lib/function/Function<%28%29=>i32> $~lib/function/Function<%28%28%29=>i32%29=>i32> $invalid
           (i32.load
            (i32.sub
             (local.get $0)
             (i32.const 8)
 ...
 (func $~start
  (call $start:closure-captured-from-nonclosure)
 )
)
