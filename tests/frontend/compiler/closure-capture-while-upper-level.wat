(module
 ...
 (global $closure-capture-while-upper-level/func1 (mut i32) (i32.const 0))
 (global $closure-capture-while-upper-level/func2 (mut i32) (i32.const 0))
 ...
 (data $8 (i32.const 412) "\\\00\00\00\00\00\00\00\00\00\00\00\02\00\00\00H\00\00\00c\00l\00o\00s\00u\00r\00e\00-\00c\00a\00p\00t\00u\00r\00e\00-\00w\00h\00i\00l\00e\00-\00u\00p\00p\00e\00r\00-\00l\00e\00v\00e\00l\00.\00t\00s\00\00\00\00\00")
 ...
 (table $0 2 2 funcref)
 (elem $0 (i32.const 1) $closure-capture-while-upper-level/outer~inner)
 (export "outer" (func $closure-capture-while-upper-level/outer))
 ...
 (func $closure-capture-while-upper-level/outer~inner (result i32)
  (local $0 i32)
  (local.set $0
 ...
 (func $closure-capture-while-upper-level/outer (result i32)
  (local $0 i32)
  (local $x i32)
  (local $i i32)
  (local $3 i32)
 ...
 (func $start:closure-capture-while-upper-level
  (local $0 i32)
  (local $1 i32)
  (local $2 i32)
  (local $3 i32)
   ...
   (i32.eqz
    (i32.eq
     (block (result i32)
      ...
      (call $closure-capture-while-upper-level/outer)
     )
     (i32.const 100)
    )
   )
  ...
  (if
   (i32.eqz
    (i32.ne
     (global.get $closure-capture-while-upper-level/func1)
     (i32.const 0)
    )
   )
   (then
  ...
  (if
   (i32.eqz
    (i32.ne
     (global.get $closure-capture-while-upper-level/func2)
     (i32.const 0)
    )
   )
   (then
 ...
 (func $~start
  (call $start:closure-capture-while-upper-level)
 )
)
