(module
 ...
 (data $8.1 (i32.const 424) "\02\00\00\00\16\00\00\00t\00u\00p\00l\00e\00-\00g\00c\00.\00t\00s")
 (data $9 (i32.const 464) "\06\00\00\00 \00\00\00 \00\00\00 \00\00\00\00\00\00\00 ")
 ...
 (func $~lib/tuple/SmallTuple#__set<tuple-gc/Box> (param $0 i32) (param $1 i32) (param $2 i32)
  local.get $0
  local.get $1
  i32.add
  local.get $2
   ...
   block $~lib/tuple/SmallTuple
    block $tuple-gc/Box
     block $~lib/arraybuffer/ArrayBufferView
      ...
      i32.sub
      i32.load
      br_table $tuple-gc/Box $tuple-gc/Box $tuple-gc/Box $~lib/arraybuffer/ArrayBufferView $tuple-gc/Box $~lib/tuple/SmallTuple $invalid
     end
     local.get $0
     i32.load
     call $~lib/rt/itcms/__visit
