(module
 ...
 (global $unused-field-store-read/packet (mut i32) (i32.const 0))
 ...
 (data $8 (i32.const 412) "L\00\00\00\00\00\00\00\00\00\00\00\02\00\00\004\00\00\00u\00n\00u\00s\00e\00d\00-\00f\00i\00e\00l\00d\00-\00s\00t\00o\00r\00e\00-\00r\00e\00a\00d\00.\00t\00s\00\00\00\00\00\00\00\00\00")
 ...
 (func $unused-field-store-read/Packet#constructor (param $this i32) (result i32)
  (local.set $this
 ...
 (func $unused-field-store-read/Packet#set:used (param $this i32) (param $used i32)
  (i32.store
   (local.get $this)
   (local.get $used)
  )
 )
 (func $unused-field-store-read/writeUsed (param $packet i32)
  (call $unused-field-store-read/Packet#set:used
   (call $~lib/rt/__tmptostack
    (local.get $packet)
   )
   (i32.const 7)
 ...
 (func $unused-field-store-read/Packet#get:used (param $this i32) (result i32)
  (i32.load
   (local.get $this)
  )
 )
 (func $unused-field-store-read/readUsed (param $packet i32) (result i32)
  (return
   (call $unused-field-store-read/Packet#get:used
    (call $~lib/rt/__tmptostack
     (local.get $packet)
    )
   )
 ...
 (func $start:unused-field-store-read
  (global.set $~lib/rt/itcms/threshold
   (i32.shr_u
    (i32.sub
     (i32.shl
  ...
  (global.set $unused-field-store-read/packet
   (call $unused-field-store-read/Packet#constructor
    (call $~lib/rt/__tmptostack
  ...
  (call $unused-field-store-read/writeUsed
   (call $~lib/rt/__tmptostack
    (global.get $unused-field-store-read/packet)
   )
  )
  (if
   (i32.eqz
    (i32.eq
     (call $unused-field-store-read/readUsed
      (call $~lib/rt/__tmptostack
       (global.get $unused-field-store-read/packet)
      )
     )
 ...
 (func $~lib/rt/__visit_members (param $0 i32) (param $1 i32)
  (block $invalid
   (block $unused-field-store-read/Packet
    (block $~lib/arraybuffer/ArrayBufferView
     (block $~lib/string/String
      (block $~lib/arraybuffer/ArrayBuffer
       (block $~lib/object/Object
        (br_table $~lib/object/Object $~lib/arraybuffer/ArrayBuffer $~lib/string/String $~lib/arraybuffer/ArrayBufferView $unused-field-store-read/Packet $invalid
         (i32.load
          (i32.sub
           (local.get $0)
           (i32.const 8)
 ...
 (func $~start
  (call $start:unused-field-store-read)
 )
)
