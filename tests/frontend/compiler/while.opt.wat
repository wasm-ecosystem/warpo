(module
 ...
 (memory $0 1)
 (data $0 (i32.const 12) ",")
 (data $0.1 (i32.const 24) "\02\00\00\00\10\00\00\00w\00h\00i\00l\00e\00.\00t\00s")
 (data $1 (i32.const 60) "<")
  ...
  block $invalid
   block $while/Ref
    block $~lib/arraybuffer/ArrayBufferView
     ...
     i32.sub
     i32.load
     br_table $while/Ref $while/Ref $while/Ref $~lib/arraybuffer/ArrayBufferView $while/Ref $invalid
    end
    local.get $0
    i32.load
    call $~lib/rt/itcms/__visit
