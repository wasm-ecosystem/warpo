(module
 ...
 (global $~lib/memory/__data_end i32 (i32.const 400))
 (global $~lib/memory/__stack_pointer (mut i32) (i32.const 33168))
 (global $~lib/memory/__heap_base i32 (i32.const 33168))
 (memory $0 1)
