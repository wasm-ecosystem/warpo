(module
 ...
 (data $8 (i32.const 412) "<\00\00\00\00\00\00\00\00\00\00\00\02\00\00\00,\00\00\00c\00l\00o\00s\00u\00r\00e\00-\00n\00e\00s\00t\00e\00d\00-\00l\00o\00o\00p\00.\00t\00s\00")
 ...
 (func $closure-nested-loop/loopAccess (param $n i32) (param $m i32) (result i32)
  (local $2 i32)
  (local $x i32)
  (local $inner i32)
  (local.set $2
 ...
 (func $closure-nested-loop/loopMultiLevel (param $n i32) (result i32)
  (local $1 i32)
  (local $x i32)
  (local $middle i32)
  (local.set $1
 ...
 (func $start:closure-nested-loop
  (global.set $~lib/rt/itcms/threshold
   (i32.shr_u
    (i32.sub
     (i32.shl
 ...
 (func $~start
  (call $start:closure-nested-loop)
 )
)
