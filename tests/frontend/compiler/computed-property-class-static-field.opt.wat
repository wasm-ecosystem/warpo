(module
 ...
 (data $15 (i32.const 832) "\t\00\00\00 \00\00\00 \00\00\00 \00\00\00\00\00\00\00\10\01\82")
 (data $15.1 (i32.const 864) "\10A\02\00 ")
 ...
 (func $~lib/rt/itcms/__new (param $0 i32) (param $1 i32) (result i32)
  ...
  if
   block $__inlined_func$~lib/rt/itcms/interrupt$67
    ...
    loop $do-loop|0
     local.get $2
     block $__inlined_func$~lib/rt/itcms/step$179 (result i32)
      block $break|0
       block $case2|0
        block $case1|0
         block $case0|0
         ...
         global.set $~lib/rt/itcms/iter
         global.get $~lib/rt/itcms/visitCount
         br $__inlined_func$~lib/rt/itcms/step$179
        end
        global.get $~lib/rt/itcms/white
        i32.eqz
        local.set $4
      ...
      block $~lib/tuple/SmallTuple
       block $"~lib/map/Map<~lib/string/String,usize>"
        block $~lib/arraybuffer/ArrayBufferView
         ...
         i32.sub
         i32.load
         br_table $computed-property-class-static-field/computed_property_class_static_field.Fn $computed-property-class-static-field/computed_property_class_static_field.Fn $computed-property-class-static-field/computed_property_class_static_field.Fn $~lib/arraybuffer/ArrayBufferView $"~lib/map/Map<~lib/string/String,usize>" $~lib/tuple/SmallTuple $~lib/map/MapIteratorVersion $"~lib/map/Map<usize,~lib/string/String>" $computed-property-class-static-field/computed_property_class_static_field.Fn $invalid
        end
        local.get $0
        i32.load
 ...
 (func $~start
  ...
  block $__inlined_func$~lib/symbol/Symbol.for$201 (result i32)
   ...
   i32.const 0
   local.set $4
   block $"__inlined_func$~lib/map/Map<usize,~lib/string/String>#find$182" (result i32)
    global.get $~lib/symbol/idToString
    local.tee $1
    i32.load
    local.get $9
    ...
    loop $while-continue|00
     ...
     if
      ...
      br_if $"__inlined_func$~lib/map/Map<usize,~lib/string/String>#find$182"
      drop
      local.get $2
      i32.const -2
      i32.and
