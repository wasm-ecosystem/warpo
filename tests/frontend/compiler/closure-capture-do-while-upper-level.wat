(module
 ...
 (global $closure-capture-do-while-upper-level/func1 (mut i32) (i32.const 0))
 (global $closure-capture-do-while-upper-level/func2 (mut i32) (i32.const 0))
 ...
 (data $8 (i32.const 412) "l\00\00\00\00\00\00\00\00\00\00\00\02\00\00\00N\00\00\00c\00l\00o\00s\00u\00r\00e\00-\00c\00a\00p\00t\00u\00r\00e\00-\00d\00o\00-\00w\00h\00i\00l\00e\00-\00u\00p\00p\00e\00r\00-\00l\00e\00v\00e\00l\00.\00t\00s\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00")
 (data $9 (i32.const 524) "|\00\00\00\00\00\00\00\00\00\00\00\02\00\00\00^\00\00\00U\00n\00e\00x\00p\00e\00c\00t\00e\00d\00 \00\'\00n\00u\00l\00l\00\'\00 \00(\00n\00o\00t\00 \00a\00s\00s\00i\00g\00n\00e\00d\00 \00o\00r\00 \00f\00a\00i\00l\00e\00d\00 \00c\00a\00s\00t\00)\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00")
 (data $10 (i32.const 656) "\06\00\00\00 \00\00\00 \00\00\00 \00\00\00\00\00\00\00\00\00\00\00\00\00\00\00")
 (table $0 2 2 funcref)
 (elem $0 (i32.const 1) $closure-capture-do-while-upper-level/outer~inner)
 (export "outer" (func $closure-capture-do-while-upper-level/outer))
 ...
 (func $closure-capture-do-while-upper-level/outer~inner (result i32)
  (local $0 i32)
  (local.set $0
 ...
 (func $closure-capture-do-while-upper-level/outer (result i32)
  (local $0 i32)
  (local $x i32)
  (local $i i32)
  (local $3 i32)
  ...
  (loop $do-loop|0
   ...
   (if
    ...
    (then
     (global.set $closure-capture-do-while-upper-level/func1
      (local.get $inner)
     )
    )
    (else
     (global.set $closure-capture-do-while-upper-level/func2
      (local.get $inner)
     )
    )
   )
 ...
 (func $start:closure-capture-do-while-upper-level
  (local $0 i32)
  (local $1 i32)
  (local $2 i32)
  (local $3 i32)
   ...
   (i32.eqz
    (i32.eq
     (block (result i32)
      ...
      (call $closure-capture-do-while-upper-level/outer)
     )
     (i32.const 100)
    )
   )
  ...
  (if
   (i32.eqz
    (i32.ne
     (global.get $closure-capture-do-while-upper-level/func1)
     (i32.const 0)
    )
   )
   (then
  ...
  (if
   (i32.eqz
    (i32.ne
     (global.get $closure-capture-do-while-upper-level/func2)
     (i32.const 0)
    )
   )
   (then
 ...
 (func $~start
  (call $start:closure-capture-do-while-upper-level)
 )
)
