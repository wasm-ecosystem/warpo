(module
 ...
 (data $8 (i32.const 412) "<\00\00\00\00\00\00\00\00\00\00\00\02\00\00\00(\00\00\00c\00l\00o\00s\00u\00r\00e\00-\00m\00u\00l\00t\00i\00-\00v\00a\00r\00.\00t\00s\00\00\00\00\00")
 (data $9 (i32.const 480) "\06\00\00\00 \00\00\00 \00\00\00 \00\00\00\00\00\00\00\00\00\00\00\00\00\00\00")
 (table $0 2 2 funcref)
 (elem $0 (i32.const 1) $closure-multi-var/outer~inner)
 (export "outer" (func $closure-multi-var/outer))
 ...
 (func $closure-multi-var/outer~inner (result i32)
  (local $0 i32)
  (local.set $0
 ...
 (func $closure-multi-var/outer (param $a i32) (param $b i32) (result i32)
  (local $2 i32)
  (local $x i32)
  (local $y i32)
  (local $inner i32)
