(module
 ...
 (data $8 (i32.const 412) "\\\00\00\00\00\00\00\00\00\00\00\00\02\00\00\00>\00\00\00u\00n\00u\00s\00e\00d\00-\00f\00i\00e\00l\00d\00-\00s\00t\00o\00r\00e\00-\00u\00n\00r\00e\00l\00a\00t\00e\00d\00.\00t\00s\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00")
 (data $9 (i32.const 512) "\06\00\00\00 \00\00\00 \00\00\00 \00\00\00\00\00\00\00 \00\00\00 \00\00\00")
 (table $0 1 1 funcref)
 (elem $0 (i32.const 1))
 ...
 (func $unused-field-store-unrelated/Base#constructor (param $this i32) (result i32)
  (local.set $this
 ...
 (func $unused-field-store-unrelated/Base#set:value (param $this i32) (param $value i32)
  (i32.store
   (local.get $this)
   (local.get $value)
  )
 )
 (func $unused-field-store-unrelated/writeBase (param $object i32)
  (call $unused-field-store-unrelated/Base#set:value
   (call $~lib/rt/__tmptostack
    (local.get $object)
   )
   (i32.const 1)
 ...
 (func $unused-field-store-unrelated/Unrelated#constructor (param $this i32) (result i32)
  (local.set $this
   (call $~lib/rt/__localtostack
    (call $~lib/object/Object#constructor
     (call $~lib/rt/__tmptostack
 ...
 (func $unused-field-store-unrelated/Unrelated#get:value (param $this i32) (result i32)
  (i32.load
   (local.get $this)
  )
 )
 (func $unused-field-store-unrelated/readUnrelated (param $object i32) (result i32)
  (return
   (call $unused-field-store-unrelated/Unrelated#get:value
    (call $~lib/rt/__tmptostack
     (local.get $object)
    )
   )
 ...
 (func $start:unused-field-store-unrelated
  (global.set $~lib/rt/itcms/threshold
   (i32.shr_u
    (i32.sub
     (i32.shl
  ...
  (call $unused-field-store-unrelated/writeBase
   (call $~lib/rt/__tmptostack
    (call $unused-field-store-unrelated/Base#constructor
     (call $~lib/rt/__tmptostack
  ...
  (if
   (i32.eqz
    (i32.eq
     (call $unused-field-store-unrelated/readUnrelated
      (call $~lib/rt/__tmptostack
       (call $unused-field-store-unrelated/Unrelated#constructor
        (call $~lib/rt/__tmptostack
         (call $~lib/rt/itcms/__new
          (i32.const 4)
          (i32.const 5)
 ...
 (func $~lib/rt/__visit_members (param $0 i32) (param $1 i32)
  (block $invalid
   (block $unused-field-store-unrelated/Unrelated
    (block $unused-field-store-unrelated/Base
     (block $~lib/arraybuffer/ArrayBufferView
      (block $~lib/string/String
       (block $~lib/arraybuffer/ArrayBuffer
        (block $~lib/object/Object
         (br_table $~lib/object/Object $~lib/arraybuffer/ArrayBuffer $~lib/string/String $~lib/arraybuffer/ArrayBufferView $unused-field-store-unrelated/Base $unused-field-store-unrelated/Unrelated $invalid
          (i32.load
           (i32.sub
            (local.get $0)
            (i32.const 8)
 ...
 (func $~start
  (call $start:unused-field-store-unrelated)
 )
)
