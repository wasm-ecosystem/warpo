(module
 ...
 (data $8 (i32.const 412) "\\\00\00\00\00\00\00\00\00\00\00\00\02\00\00\00D\00\00\00c\00l\00o\00s\00u\00r\00e\00-\00c\00l\00a\00s\00s\00-\00a\00r\00r\00o\00w\00-\00t\00h\00i\00s\00-\00s\00e\00t\00t\00e\00r\00.\00t\00s\00\00\00\00\00\00\00\00\00")
 (data $9 (i32.const 512) "\07\00\00\00 \00\00\00 \00\00\00 \00\00\00\00\00\00\00 \00\00\00\00\00\00\00\00\00\00\00")
 (table $0 2 2 funcref)
 (elem $0 (i32.const 1) $closure-class-arrow-this-setter/FromSetter#set:update~anonymous|0)
 (export "memory" (memory $0))
 (start $~start)
 (func $~lib/object/Object#constructor (param $this i32) (result i32)
  (local.get $this)
 )
 (func $closure-class-arrow-this-setter/FromSetter#constructor (param $this i32) (result i32)
  (local.set $this
 ...
 (func $closure-class-arrow-this-setter/FromSetter#set:value (param $this i32) (param $value i32)
  (i32.store
   (local.get $this)
   (local.get $value)
  )
 )
 (func $~lib/tuple/SmallTuple#__get<closure-class-arrow-this-setter/FromSetter> (param $this i32) (param $offset i32) (result i32)
 ...
 (func $closure-class-arrow-this-setter/FromSetter#get:value (param $this i32) (result i32)
  (i32.load
   (local.get $this)
  )
 )
 ...
 (func $closure-class-arrow-this-setter/FromSetter#set:stored (param $this i32) (param $stored i32)
  (i32.store offset=4
   (local.get $this)
   (local.get $stored)
  )
 ...
 (func $closure-class-arrow-this-setter/FromSetter#set:update~anonymous|0
  ...
  (call $closure-class-arrow-this-setter/FromSetter#set:stored
   (call $~lib/rt/__tmptostack
    (call $~lib/tuple/SmallTuple#__get<closure-class-arrow-this-setter/FromSetter>
     (call $~lib/rt/__tmptostack
   ...
   (i32.add
    (call $closure-class-arrow-this-setter/FromSetter#get:value
     (call $~lib/rt/__tmptostack
      (call $~lib/tuple/SmallTuple#__get<closure-class-arrow-this-setter/FromSetter>
       (call $~lib/rt/__tmptostack
        (call $~lib/rt/closure/getClosureEnvByLevel
 ...
 (func $~lib/tuple/SmallTuple#__set<closure-class-arrow-this-setter/FromSetter> (param $this i32) (param $offset i32) (param $value i32)
  (local $elementPtr i32)
  (local.set $elementPtr
   (i32.add
    (local.get $this)
 ...
 (func $closure-class-arrow-this-setter/FromSetter#set:update (param $this i32) (param $v i32)
  (local $2 i32)
  (local $apply i32)
  (local.set $2
   (call $~lib/rt/__localtostack
 ...
 (func $closure-class-arrow-this-setter/FromSetter#get:stored (param $this i32) (result i32)
  (i32.load offset=4
   (local.get $this)
  )
 )
 (func $start:closure-class-arrow-this-setter
  (global.set $~lib/rt/itcms/threshold
   (i32.shr_u
    (i32.sub
     (i32.shl
  ...
  (global.set $closure-class-arrow-this-setter/s
   (call $closure-class-arrow-this-setter/FromSetter#constructor
    (call $~lib/rt/__tmptostack
     (call $~lib/rt/itcms/__new
      (i32.const 8)
      (i32.const 4)
  ...
  (call $closure-class-arrow-this-setter/FromSetter#set:value
   (call $~lib/rt/__tmptostack
  ...
  (block
   ...
   (call $closure-class-arrow-this-setter/FromSetter#set:update
    (call $~lib/rt/__tmptostack
     (global.get $closure-class-arrow-this-setter/s)
    )
    (i32.const 2)
  ...
  (if
   (i32.eqz
    (i32.eq
     (call $closure-class-arrow-this-setter/FromSetter#get:stored
      (call $~lib/rt/__tmptostack
       (global.get $closure-class-arrow-this-setter/s)
      )
     )
  ...
  (block $invalid
   (block $~lib/function/Function<%28%29=>void>
    (block $~lib/tuple/SmallTuple
     (block $closure-class-arrow-this-setter/FromSetter
      (block $~lib/arraybuffer/ArrayBufferView
       (block $~lib/string/String
        (block $~lib/arraybuffer/ArrayBuffer
         (block $~lib/object/Object
          (br_table $~lib/object/Object $~lib/arraybuffer/ArrayBuffer $~lib/string/String $~lib/arraybuffer/ArrayBufferView $closure-class-arrow-this-setter/FromSetter $~lib/tuple/SmallTuple $~lib/function/Function<%28%29=>void> $invalid
           (i32.load
            (i32.sub
             (local.get $0)
             (i32.const 8)
 ...
 (func $~start
  (call $start:closure-class-arrow-this-setter)
 )
)
