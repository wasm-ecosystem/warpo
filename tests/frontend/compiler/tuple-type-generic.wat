(module
 ...
 (global $tuple-type-generic/disableScriptMode i32 (i32.const 1))
 ...
 (data $9 (i32.const 444) "<\00\00\00\00\00\00\00\00\00\00\00\02\00\00\00*\00\00\00t\00u\00p\00l\00e\00-\00t\00y\00p\00e\00-\00g\00e\00n\00e\00r\00i\00c\00.\00t\00s\00\00\00")
 (data $10 (i32.const 512) "\05\00\00\00 \00\00\00 \00\00\00 \00\00\00\00\00\00\00\00\00\00\00")
 (table $0 1 1 funcref)
 (elem $0 (i32.const 1))
 (export "disableScriptMode" (global $tuple-type-generic/disableScriptMode))
 ...
 (func $"tuple-type-generic/testTupleInGeneric<[i32, ~lib/string/String]>" (param $t i32) (result i32)
  (return
 ...
 (func $~lib/tuple/SmallTuple#__set<i64> (param $this i32) (param $offset i32) (param $value i64)
  (local $elementPtr i32)
  (local.set $elementPtr
   (i32.add
    (local.get $this)
 ...
 (func $~lib/tuple/SmallTuple#__get<i64> (param $this i32) (param $offset i32) (result i64)
  (local $elementPtr i32)
  (local.set $elementPtr
   (i32.add
    (local.get $this)
 ...
 (func $"tuple-type-generic/testTupleInGeneric<[i64, i32]>" (param $t i32) (result i32)
  (return
   (i32.wrap_i64
    (call $~lib/tuple/SmallTuple#__get<i64>
     (call $~lib/rt/__tmptostack
      (local.get $t)
     )
     (i32.const 0)
 ...
 (func $start:tuple-type-generic
  ...
  (if
   (i32.eqz
    (i32.eq
     (call $"tuple-type-generic/testTupleInGeneric<[i32, ~lib/string/String]>"
      (call $~lib/rt/__tmptostack
       (block (result i32)
        (local.set $0
  ...
  (if
   (i32.eqz
    (i32.eq
     (call $"tuple-type-generic/testTupleInGeneric<[i64, i32]>"
      (call $~lib/rt/__tmptostack
       (block (result i32)
        (local.set $1
         (call $~lib/rt/__localtostack
        ...
        (call $~lib/tuple/SmallTuple#__set<i64>
         (call $~lib/rt/__tmptostack
          (local.get $1)
         )
         (i32.const 0)
