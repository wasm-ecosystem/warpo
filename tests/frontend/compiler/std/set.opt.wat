(module
 ...
 (func $~start
  ...
  block $folding-inner17
   block $__inlined_func$start:std/set$676
                  ...
                  block $folding-inner2
                   block $folding-inner1
                    block $folding-inner0
                     ...
                     i32.add
                     global.set $~lib/rt/itcms/threshold
                     br $__inlined_func$start:std/set$676
                    end
                    i32.const 0
                    i32.const 544
                    i32.const 6
 ...
 (func $byn$mgfn-shared$~lib/array/Array<i16>#constructor (param $0 i32) (param $1 i32) (param $2 i32) (param $3 i32) (result i32)
  local.get $1
  local.get $3
  i32.gt_u
  if
 ...
 (func $byn$mgfn-shared$~lib/set/Set<i64>#constructor@new (param $0 i32) (result i32)
  local.get $0
  i32.const 64
  return_call $byn$mgfn-shared$byn$mgfn-shared$~lib/set/Set<i64>#constructor@new
 )
