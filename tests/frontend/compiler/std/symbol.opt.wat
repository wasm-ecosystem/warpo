(module
 ...
 (data $18 (i32.const 972) "\1c\00\00\00\03\00\00\00\00\00\00\00\0b\00\00\00\0c\00\00\00\90\03\00\00\00\00\00\00\c0\03\00\00\1c")
 ...
 (func $~lib/string/String.__eq (param $0 i32) (param $1 i32) (result i32)
  ...
  block $__inlined_func$~lib/util/string/compareImpl$108 (result i32)
   local.get $0
   local.tee $2
   i32.const 7
   i32.and
   ...
   loop $while-continue|1
    ...
    if
     ...
     if
      ...
      local.get $4
      i32.sub
      br $__inlined_func$~lib/util/string/compareImpl$108
     end
     local.get $2
     i32.const 2
     i32.add
 ...
 (func $~lib/symbol/symbol#toString (param $0 i32) (result i32)
  ...
  i32.const 0
  local.set $0
  block $__inlined_func$~lib/util/string/joinStringArray$146 (result i32)
   i32.const 1024
   i32.const 988
   i32.load
   i32.const 2
   ...
   i32.const 0
   i32.lt_s
   br_if $__inlined_func$~lib/util/string/joinStringArray$146
   drop
   local.get $2
   i32.eqz
   if
    ...
    br $__inlined_func$~lib/util/string/joinStringArray$146
   end
   loop $for-loop|0
    local.get $0
    local.get $3
