(module
 ...
 (global $~lib/memory/__data_end i32 (i32.const 696))
 (global $~lib/memory/__stack_pointer (mut i32) (i32.const 33464))
 (global $~lib/memory/__heap_base i32 (i32.const 33464))
 (memory $0 1)
 ...
 (data $11 (i32.const 588) "L\00\00\00\00\00\00\00\00\00\00\00\02\00\00\00:\00\00\00s\00t\00d\00/\00c\00o\00p\00y\00w\00i\00t\00h\00i\00n\00-\00e\00m\00p\00t\00y\00-\00r\00a\00n\00g\00e\00.\00t\00s\00\00\00")
 (data $12 (i32.const 672) "\05\00\00\00 \00\00\00 \00\00\00 \00\00\00\00\00\00\00\01\t\00\00")
 (table $0 1 1 funcref)
 (elem $0 (i32.const 1))
 ...
 (func $"~lib/typedarray/COPY_WITHIN<~lib/typedarray/Int32Array,i32>" (param $array i32) (param $target i32) (param $start i32) (param $end i32) (result i32)
  (local $len i32)
  (local $ptr i32)
  (local $6 i32)
  (local $7 i32)
 ...
 (func $start:std/copywithin-empty-range
  (global.set $~lib/rt/itcms/threshold
   (i32.shr_u
    (i32.sub
     (i32.shl
 ...
 (func $~start
  (call $start:std/copywithin-empty-range)
 )
)
