(module
 ...
 (global $std/typedarray-set-overflow/target (mut i32) (i32.const 0))
 (global $std/typedarray-set-overflow/source (mut i32) (i32.const 0))
 ...
 (data $11 (i32.const 592) "\05\00\00\00 \00\00\00 \00\00\00 \00\00\00\00\00\00\00A")
 (export "memory" (memory $0))
 (start $~start)
 (func $~lib/rt/itcms/visitRoots
  (local $0 i32)
  (local $1 i32)
  global.get $std/typedarray-set-overflow/target
  local.tee $0
  if
   local.get $0
   call $~lib/rt/itcms/__visit
  end
  global.get $std/typedarray-set-overflow/source
  local.tee $0
  if
   local.get $0
   call $~lib/rt/itcms/__visit
  ...
  block $invalid
   block $~lib/typedarray/Uint8Array
    block $~lib/string/String
     ...
     i32.sub
     i32.load
     br_table $~lib/string/String $~lib/string/String $~lib/string/String $~lib/typedarray/Uint8Array $~lib/typedarray/Uint8Array $invalid
    end
    return
   end
   local.get $0
 ...
 (func $~start
  ...
  i32.const 432
  global.set $~lib/rt/itcms/fromSpace
  call $~lib/typedarray/Uint8Array#constructor@new
  global.set $std/typedarray-set-overflow/target
  call $~lib/typedarray/Uint8Array#constructor@new
  global.set $std/typedarray-set-overflow/source
  global.get $std/typedarray-set-overflow/source
  local.tee $0
  i32.load offset=8
  i32.eqz
 ...
 (func $~lib/typedarray/Uint8Array#constructor@new (result i32)
  (local $0 i32)
  global.get $~lib/memory/__stack_pointer
  i32.const 4
  i32.sub
