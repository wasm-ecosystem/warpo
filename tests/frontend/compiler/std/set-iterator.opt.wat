(module
 ...
 (data $11 (i32.const 592) "\07\00\00\00 \00\00\00 \00\00\00 \00\00\00\00\00\00\00\08\t\00\00\00\00\00\00 ")
 ...
 (func $~lib/rt/itcms/__new (param $0 i32) (param $1 i32) (result i32)
  ...
  if
   block $__inlined_func$~lib/rt/itcms/interrupt$67
    ...
    loop $do-loop|0
     local.get $2
     block $__inlined_func$~lib/rt/itcms/step$147 (result i32)
      block $break|0
       block $case2|0
        block $case1|0
         block $case0|0
         ...
         global.set $~lib/rt/itcms/iter
         global.get $~lib/rt/itcms/visitCount
         br $__inlined_func$~lib/rt/itcms/step$147
        end
        global.get $~lib/rt/itcms/white
        i32.eqz
        local.set $4
 ...
 (func $"~lib/set/Set<i32>#[~lib/symbol/Symbol.iterator]" (param $0 i32) (result i32)
  (local $1 i32)
  i32.const 8
  i32.const 5
 ...
 (func $std/set-iterator/set_iterator_add
  ...
  i32.const 8
  call $~lib/rt/__decrease_sp
  call $~lib/set/Set<i32>#constructor@new
  local.set $1
  global.get $~lib/memory/__stack_pointer
  local.get $1
    ...
    block $~lib/set/SetIterator<i32>
     block $~lib/set/Set<i32>
      block $~lib/arraybuffer/ArrayBufferView
       ...
       i32.sub
       i32.load
       br_table $~lib/iterator/IteratorResult<i32> $~lib/iterator/IteratorResult<i32> $~lib/iterator/IteratorResult<i32> $~lib/arraybuffer/ArrayBufferView $~lib/set/Set<i32> $~lib/set/SetIterator<i32> $~lib/iterator/IteratorResult<i32> $invalid
      end
      local.get $0
      i32.load
 ...
 (func $~start
  ...
  return_call $std/set-iterator/set_iterator_clear
 )
 ...
 (func $~lib/set/Set<i32>#constructor@new (result i32)
  (local $0 i32)
  (local $1 i32)
  i32.const 4
  call $~lib/rt/__decrease_sp
