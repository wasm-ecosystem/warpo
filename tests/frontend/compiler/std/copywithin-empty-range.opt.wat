(module
 ...
 (global $std/copywithin-empty-range/values (mut i32) (i32.const 0))
 (global $~lib/memory/__stack_pointer (mut i32) (i32.const 33464))
 (memory $0 1)
 (data $0 (i32.const 12) ",")
 ...
 (data $11 (i32.const 588) "L")
 (data $11.1 (i32.const 600) "\02\00\00\00:\00\00\00s\00t\00d\00/\00c\00o\00p\00y\00w\00i\00t\00h\00i\00n\00-\00e\00m\00p\00t\00y\00-\00r\00a\00n\00g\00e\00.\00t\00s")
 (data $12 (i32.const 672) "\05\00\00\00 \00\00\00 \00\00\00 \00\00\00\00\00\00\00\01\t")
 (export "memory" (memory $0))
 (start $~start)
 (func $~lib/rt/itcms/visitRoots
  (local $0 i32)
  (local $1 i32)
  global.get $std/copywithin-empty-range/values
  local.tee $0
  if
   local.get $0
  ...
  block $invalid
   block $~lib/typedarray/Int32Array
    block $~lib/string/String
     ...
     i32.sub
     i32.load
     br_table $~lib/string/String $~lib/string/String $~lib/string/String $~lib/typedarray/Int32Array $~lib/typedarray/Int32Array $invalid
    end
    return
   end
   local.get $0
 ...
 (func $~start
  ...
  i32.store offset=8
  local.get $0
  global.set $std/copywithin-empty-range/values
  global.get $std/copywithin-empty-range/values
  i32.const 0
  i32.const 1
