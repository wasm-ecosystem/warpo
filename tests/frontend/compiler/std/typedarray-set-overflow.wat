(module
 ...
 (data $11 (i32.const 592) "\05\00\00\00 \00\00\00 \00\00\00 \00\00\00\00\00\00\00A\00\00\00")
 (table $0 1 1 funcref)
 (elem $0 (i32.const 1))
 ...
 (func $"~lib/typedarray/SET<~lib/typedarray/Uint8Array,~lib/typedarray/Uint8Array>" (param $target i32) (param $source i32) (param $offset i32)
  (local $sourceLen i32)
 ...
 (func $~lib/typedarray/Uint8Array#set<~lib/typedarray/Uint8Array> (param $this i32) (param $source i32) (param $offset i32)
  (call $"~lib/typedarray/SET<~lib/typedarray/Uint8Array,~lib/typedarray/Uint8Array>"
   (call $~lib/rt/__tmptostack
    (local.get $this)
   )
   (call $~lib/rt/__tmptostack
 ...
 (func $start:std/typedarray-set-overflow
  (global.set $~lib/rt/itcms/threshold
   (i32.shr_u
    (i32.sub
     (i32.shl
 ...
 (func $~start
  (call $start:std/typedarray-set-overflow)
 )
)
