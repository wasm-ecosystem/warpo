(module
 ...
 (func $~lib/array/Array<i32>#join (param $0 i32) (param $1 i32) (result i32)
  ...
  (local $6 i32)
  (local $7 i32)
  block $__inlined_func$~lib/util/string/joinIntegerArray<i32>$198 (result i32)
   local.get $0
   i32.load offset=4
   local.set $4
   local.get $0
 ...
 (func $~lib/iterator/Iterator<i32>#next@override (param $0 i32) (result i32)
  ...
  i32.eq
  if
   block $__inlined_func$~lib/array/ArrayIterator<i32>#next$214 (result i32)
    local.get $0
    i32.load
    local.set $1
    local.get $0
    ...
    i32.load offset=12
    i32.ge_s
    br_if $__inlined_func$~lib/array/ArrayIterator<i32>#next$214
    drop
    local.get $0
    i32.load offset=4
    i32.load offset=4
