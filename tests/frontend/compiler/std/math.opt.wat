(module
 ...
 (func $std/math/test_acosh (param $0 f64) (param $1 f64) (param $2 f64) (result i32)
  (local $3 i64)
  block $__inlined_func$~lib/math/NativeMath.acosh$4 (result f64)
   local.get $0
   local.get $0
   f64.sub
   f64.const 0
   ...
   i64.lt_s
   br_if $__inlined_func$~lib/math/NativeMath.acosh$4
   drop
   local.get $3
   i64.const 52
   i64.shr_u
   ...
   if
    ...
    br $__inlined_func$~lib/math/NativeMath.acosh$4
   end
   local.get $3
   i64.const 1049
   i64.lt_u
 ...
 (func $std/math/test_atan2 (param $0 f64) (param $1 f64) (param $2 f64) (param $3 f64) (result i32)
  ...
  (local $7 i64)
  (local $8 i32)
  block $__inlined_func$~lib/math/NativeMath.atan2$12 (result f64)
   local.get $1
   local.get $0
   f64.add
   local.get $0
   ...
   f64.ne
   i32.or
   br_if $__inlined_func$~lib/math/NativeMath.atan2$12
   drop
   local.get $1
   i64.reinterpret_f64
   local.tee $7
   ...
   if
    local.get $0
    call $~lib/math/NativeMath.atan
    br $__inlined_func$~lib/math/NativeMath.atan2$12
   end
   local.get $5
   i32.const 30
   i32.shr_u
 ...
 (func $std/math/test_atan2f (param $0 f32) (param $1 f32) (param $2 f32) (param $3 f32) (result i32)
  ...
  (local $5 i32)
  (local $6 i32)
  block $__inlined_func$~lib/math/NativeMathf.atan2$13 (result f32)
   local.get $1
   local.get $0
   f32.add
   local.get $0
   ...
   f32.ne
   i32.or
   br_if $__inlined_func$~lib/math/NativeMathf.atan2$13
   drop
   local.get $1
   i32.reinterpret_f32
   local.tee $5
   ...
   if
    local.get $0
    call $~lib/math/NativeMathf.atan
    br $__inlined_func$~lib/math/NativeMathf.atan2$13
   end
   local.get $5
   i32.const 30
   i32.shr_u
 ...
 (func $std/math/test_hypot (param $0 f64) (param $1 f64) (param $2 f64) (param $3 f64) (result i32)
  ...
  (local $13 f64)
  (local $14 i64)
  block $__inlined_func$~lib/math/NativeMath.hypot$21 (result f64)
   local.get $0
   i64.reinterpret_f64
   i64.const 9223372036854775807
   i64.and
   ...
   i32.const 2047
   i32.eq
   br_if $__inlined_func$~lib/math/NativeMath.hypot$21
   drop
   local.get $5
   f64.reinterpret_i64
   local.tee $1
 ...
 (func $std/math/test_log10 (param $0 f64) (param $1 f64) (param $2 f64) (result i32)
  ...
  (local $10 i32)
  (local $11 f64)
  block $__inlined_func$~lib/math/NativeMath.log10$23 (result f64)
   local.get $0
   i64.reinterpret_f64
   local.tee $6
   i64.const 32
   ...
   if
    ...
    i64.shl
    i64.eqz
    br_if $__inlined_func$~lib/math/NativeMath.log10$23
    drop
    local.get $0
    local.get $0
    f64.sub
    ...
    if
     local.get $0
     br $__inlined_func$~lib/math/NativeMath.log10$23
    else
     f64.const 0
     local.get $6
     i64.const 32
 ...
 (func $std/math/test_log10f (param $0 f32) (param $1 f32) (param $2 f32) (result i32)
  ...
  (local $9 i32)
  (local $10 f32)
  block $__inlined_func$~lib/math/NativeMathf.log10$24 (result f32)
   local.get $0
   i32.reinterpret_f32
   local.tee $3
   i32.const 31
   ...
   if
    ...
    i32.shl
    i32.eqz
    br_if $__inlined_func$~lib/math/NativeMathf.log10$24
    drop
    local.get $0
    local.get $0
    f32.sub
    ...
    if
     local.get $0
     br $__inlined_func$~lib/math/NativeMathf.log10$24
    else
     f32.const 0
     local.get $3
     i32.const 1065353216
 ...
 (func $std/math/test_mod (param $0 f64) (param $1 f64) (param $2 f64) (result i32)
  ...
  (local $7 i64)
  (local $8 i64)
  block $__inlined_func$~lib/math/NativeMath.mod$27 (result f64)
   local.get $0
   local.get $0
   f64.trunc
   f64.sub
   ...
   f64.const 1
   f64.eq
   br_if $__inlined_func$~lib/math/NativeMath.mod$27
   drop
   local.get $1
   i64.reinterpret_f64
   local.tee $4
   ...
   if
    ...
    local.get $0
    f64.div
    br $__inlined_func$~lib/math/NativeMath.mod$27
   end
   local.get $6
   i64.const 1
   i64.shl
 ...
 (func $std/math/test_modf (param $0 f32) (param $1 f32) (param $2 f32) (result i32)
  ...
  (local $7 i32)
  (local $8 i32)
  block $__inlined_func$~lib/math/NativeMathf.mod$28 (result f32)
   local.get $0
   local.get $0
   f32.trunc
   f32.sub
   ...
   f32.const 1
   f32.eq
   br_if $__inlined_func$~lib/math/NativeMathf.mod$28
   drop
   local.get $1
   i32.reinterpret_f32
   local.tee $4
   ...
   if
    ...
    local.get $0
    f32.div
    br $__inlined_func$~lib/math/NativeMathf.mod$28
   end
   local.get $6
   i32.const 1
   i32.shl
 ...
 (func $std/math/test_sinf (param $0 f32) (param $1 f32) (param $2 f32) (result i32)
  ...
  (local $10 i32)
  (local $11 i64)
  block $__inlined_func$~lib/math/NativeMathf.sin$34 (result f32)
   local.get $0
   i32.reinterpret_f32
   local.tee $8
   i32.const 2147483647
   ...
   if
    ...
    f64.add
    f32.demote_f64
    br $__inlined_func$~lib/math/NativeMathf.sin$34
   end
   local.get $8
   i32.const 31
   i32.shr_u
