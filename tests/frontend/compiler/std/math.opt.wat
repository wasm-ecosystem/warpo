(module
 ...
 (type $4 (func (param f64 f64 f64 f64) (result i32)))
 (type $5 (func (param f32 f32 f32 f32) (result i32)))
 ...
 (type $13 (func (param f32 i32) (result f32)))
 (type $14 (func (param f64 i32 f64) (result i32)))
 (type $15 (func (param f32 i32 f32) (result i32)))
 ...
 (type $22 (func))
 (import "env" "Math.E" (global $std/math/JSMath.E f64))
 (import "env" "Math.LN2" (global $std/math/JSMath.LN2 f64))
 (import "env" "Math.LN10" (global $std/math/JSMath.LN10 f64))
 (import "env" "Math.LOG2E" (global $std/math/JSMath.LOG2E f64))
 (import "env" "Math.PI" (global $std/math/JSMath.PI f64))
 (import "env" "Math.SQRT1_2" (global $std/math/JSMath.SQRT1_2 f64))
 (import "env" "Math.SQRT2" (global $std/math/JSMath.SQRT2 f64))
 (import "env" "abort" (func $~lib/builtins/abort (param i32 i32 i32 i32)))
 (import "env" "Math.cos" (func $std/math/JSMath.cos (param f64) (result f64)))
 (import "env" "Math.random" (func $std/math/JSMath.random (result f64)))
 (import "env" "seed" (func $~lib/builtins/seed (result f64)))
 (import "env" "Math.sin" (func $std/math/JSMath.sin (param f64) (result f64)))
 (import "env" "Math.tan" (func $std/math/JSMath.tan (param f64) (result f64)))
 ...
 (func $std/math/check<f64> (param $0 f64) (param $1 f64) (param $2 f64) (result i32)
  ...
  (local $4 i32)
  (local $5 i32)
  block $~CONDITION_RETURN/std/math/check<f64> (result i32)
   i32.const 1
   local.get $0
   local.get $1
   f64.eq
   ...
   drop
   i32.const 0
   block $~CONDITION_RETURN/std/math/ulperr (result f64)
    f64.const 0
    local.get $4
    local.get $5
    i32.and
    br_if $~CONDITION_RETURN/std/math/ulperr
    drop
    local.get $3
    if
     local.get $2
     ...
     drop
     f64.const inf
     br $~CONDITION_RETURN/std/math/ulperr
    end
    local.get $0
    local.get $0
    f64.sub
 ...
 (func $std/math/check<f32> (param $0 f32) (param $1 f32) (param $2 f32) (result i32)
  ...
  (local $4 i32)
  (local $5 i32)
  block $~CONDITION_RETURN/std/math/check<f32> (result i32)
   i32.const 1
   local.get $0
   local.get $1
   f32.eq
   ...
   drop
   i32.const 0
   block $~CONDITION_RETURN/std/math/ulperrf (result f32)
    f32.const 0
    local.get $4
    local.get $5
    i32.and
    br_if $~CONDITION_RETURN/std/math/ulperrf
    drop
    local.get $3
    if
     local.get $2
     ...
     drop
     f32.const inf
     br $~CONDITION_RETURN/std/math/ulperrf
    end
    local.get $0
    local.get $0
    f32.sub
 ...
 (func $std/math/test_scalbn (param $0 f64) (param $1 i32) (param $2 f64) (result i32)
  ...
  local.get $2
  f64.const 0
  return_call $std/math/check<f64>
 )
 (func $std/math/test_scalbnf (param $0 f32) (param $1 i32) (param $2 f32) (result i32)
  ...
  local.get $2
  f32.const 0
  return_call $std/math/check<f32>
 )
 ...
 (func $std/math/test_acos (param $0 f64) (param $1 f64) (param $2 f64) (result i32)
  ...
  (local $5 i32)
  (local $6 f64)
  block $~CONDITION_RETURN/~lib/math/NativeMath.acos (result f64)
   local.get $0
   i64.reinterpret_f64
   i64.const 32
   i64.shr_u
   ...
   if
    ...
    if
     ...
     i32.const 0
     i32.lt_s
     br_if $~CONDITION_RETURN/~lib/math/NativeMath.acos
     drop
     f64.const 0
     br $~CONDITION_RETURN/~lib/math/NativeMath.acos
    end
    f64.const 0
    local.get $0
    local.get $0
 ...
 (func $std/math/test_acosf (param $0 f32) (param $1 f32) (param $2 f32) (result i32)
  ...
  (local $5 i32)
  (local $6 f32)
  block $~CONDITION_RETURN/~lib/math/NativeMathf.acos (result f32)
   local.get $0
   i32.reinterpret_f32
   local.tee $5
   i32.const 2147483647
   ...
   if
    ...
    i32.const 1065353216
    i32.eq
    br_if $~CONDITION_RETURN/~lib/math/NativeMathf.acos
    drop
    f32.const 0
    local.get $0
    local.get $0
    f32.sub
    f32.div
    br $~CONDITION_RETURN/~lib/math/NativeMathf.acos
   end
   local.get $4
 ...
 (func $~lib/math/NativeMath.log1p (param $0 f64) (result f64)
  ...
  (local $6 f64)
  (local $7 f64)
  block $~CONDITION_RETURN/~lib/math/NativeMath.log1p (result f64)
   i32.const 1
   local.set $3
   local.get $0
   i64.reinterpret_f64
   ...
   if
    ...
    if
     ...
     f64.const -1
     f64.eq
     br_if $~CONDITION_RETURN/~lib/math/NativeMath.log1p
     drop
     local.get $0
     local.get $0
     f64.sub
 ...
 (func $std/math/test_acosh (param $0 f64) (param $1 f64) (param $2 f64) (result i32)
  (local $3 i64)
  block $~CONDITION_RETURN/~lib/math/NativeMath.acosh (result f64)
   local.get $0
   local.get $0
   f64.sub
   f64.const 0
   ...
   i64.lt_s
   br_if $~CONDITION_RETURN/~lib/math/NativeMath.acosh
   drop
   local.get $3
   i64.const 52
   i64.shr_u
   ...
   if
    ...
    br $~CONDITION_RETURN/~lib/math/NativeMath.acosh
   end
   local.get $3
   i64.const 1049
   i64.lt_u
 ...
 (func $~lib/math/NativeMathf.log1p (param $0 f32) (result f32)
  ...
  (local $5 f32)
  (local $6 f32)
  block $~CONDITION_RETURN/~lib/math/NativeMathf.log1p (result f32)
   i32.const 1
   local.set $3
   local.get $0
   i32.reinterpret_f32
   ...
   if
    ...
    if
     ...
     f32.const -1
     f32.eq
     br_if $~CONDITION_RETURN/~lib/math/NativeMathf.log1p
     drop
     local.get $0
     local.get $0
     f32.sub
 ...
 (func $std/math/test_acoshf (param $0 f32) (param $1 f32) (param $2 f32) (result i32)
  (local $3 i32)
  block $~CONDITION_RETURN/~lib/math/NativeMathf.acosh (result f32)
   local.get $0
   i32.reinterpret_f32
   local.tee $3
   i32.const 2147483647
   ...
   if
    ...
    br $~CONDITION_RETURN/~lib/math/NativeMathf.acosh
   end
   local.get $3
 ...
 (func $std/math/test_asin (param $0 f64) (param $1 f64) (param $2 f64) (result i32)
  ...
  (local $5 f64)
  (local $6 i32)
  block $~CONDITION_RETURN/~lib/math/NativeMath.asin (result f64)
   local.get $0
   i64.reinterpret_f64
   i64.const 32
   i64.shr_u
   ...
   if
    ...
    i32.or
    i32.eqz
    br_if $~CONDITION_RETURN/~lib/math/NativeMath.asin
    drop
    f64.const 0
    local.get $0
    local.get $0
    f64.sub
    f64.div
    br $~CONDITION_RETURN/~lib/math/NativeMath.asin
   end
   local.get $4
   i32.const 1071644672
   i32.lt_u
 ...
 (func $std/math/test_asinf (param $0 f32) (param $1 f32) (param $2 f32) (result i32)
  ...
  (local $4 f32)
  (local $5 f64)
  block $~CONDITION_RETURN/~lib/math/NativeMathf.asin (result f32)
   local.get $0
   i32.reinterpret_f32
   i32.const 2147483647
   i32.and
   ...
   if
    ...
    i32.const 1065353216
    i32.eq
    br_if $~CONDITION_RETURN/~lib/math/NativeMathf.asin
    drop
    f32.const 0
    local.get $0
    local.get $0
    f32.sub
    f32.div
    br $~CONDITION_RETURN/~lib/math/NativeMathf.asin
   end
   local.get $3
   i32.const 1056964608
   i32.lt_u
 ...
 (func $~lib/math/NativeMath.atan (param $0 f64) (result f64)
  ...
  (local $3 f64)
  (local $4 f64)
  block $~CONDITION_RETURN/~lib/math/NativeMath.atan (result f64)
   local.get $0
   local.set $4
   local.get $0
   i64.reinterpret_f64
   ...
   if
    ...
    local.get $0
    f64.ne
    br_if $~CONDITION_RETURN/~lib/math/NativeMath.atan
    drop
    f64.const 1.5707963267948966
    local.get $0
    f64.copysign
 ...
 (func $~lib/math/NativeMathf.atan (param $0 f32) (result f32)
  ...
  (local $3 f32)
  (local $4 f32)
  block $~CONDITION_RETURN/~lib/math/NativeMathf.atan (result f32)
   local.get $0
   local.set $4
   local.get $0
   i32.reinterpret_f32
   ...
   if
    ...
    local.get $0
    f32.ne
    br_if $~CONDITION_RETURN/~lib/math/NativeMathf.atan
    drop
    f32.const 1.570796251296997
    local.get $0
    f32.copysign
 ...
 (func $std/math/test_atan2 (param $0 f64) (param $1 f64) (param $2 f64) (param $3 f64) (result i32)
  ...
  (local $7 i64)
  (local $8 i32)
  block $~CONDITION_RETURN/~lib/math/NativeMath.atan2 (result f64)
   local.get $1
   local.get $0
   f64.add
   local.get $0
   ...
   f64.ne
   i32.or
   br_if $~CONDITION_RETURN/~lib/math/NativeMath.atan2
   drop
   local.get $1
   i64.reinterpret_f64
   local.tee $7
   ...
   if
    local.get $0
    call $~lib/math/NativeMath.atan
    br $~CONDITION_RETURN/~lib/math/NativeMath.atan2
   end
   local.get $5
   i32.const 30
   i32.shr_u
 ...
 (func $std/math/test_atan2f (param $0 f32) (param $1 f32) (param $2 f32) (param $3 f32) (result i32)
  ...
  (local $5 i32)
  (local $6 i32)
  block $~CONDITION_RETURN/~lib/math/NativeMathf.atan2 (result f32)
   local.get $1
   local.get $0
   f32.add
   local.get $0
   ...
   f32.ne
   i32.or
   br_if $~CONDITION_RETURN/~lib/math/NativeMathf.atan2
   drop
   local.get $1
   i32.reinterpret_f32
   local.tee $5
   ...
   if
    local.get $0
    call $~lib/math/NativeMathf.atan
    br $~CONDITION_RETURN/~lib/math/NativeMathf.atan2
   end
   local.get $5
   i32.const 30
   i32.shr_u
 ...
 (func $std/math/test_cbrt (param $0 f64) (param $1 f64) (param $2 f64) (result i32)
  ...
  (local $5 f64)
  (local $6 i64)
  block $~CONDITION_RETURN/~lib/math/NativeMath.cbrt (result f64)
   local.get $0
   local.get $0
   f64.add
   local.get $0
   ...
   i32.const 2146435072
   i32.ge_u
   br_if $~CONDITION_RETURN/~lib/math/NativeMath.cbrt
   drop
   local.get $4
   i32.const 1048576
   i32.lt_u
 ...
 (func $std/math/test_cbrtf (param $0 f32) (param $1 f32) (param $2 f32) (result i32)
  ...
  (local $5 i32)
  (local $6 i32)
  block $~CONDITION_RETURN/~lib/math/NativeMathf.cbrt (result f32)
   local.get $0
   local.get $0
   f32.add
   local.get $0
   ...
   i32.const 2139095040
   i32.ge_u
   br_if $~CONDITION_RETURN/~lib/math/NativeMathf.cbrt
   drop
   local.get $5
   i32.const 8388608
   i32.lt_u
 ...
 (func $~lib/math/NativeMath.cos (param $0 f64) (result f64)
  ...
  (local $8 i32)
  (local $9 f64)
  block $~CONDITION_RETURN/~lib/math/NativeMath.cos (result f64)
   local.get $0
   i64.reinterpret_f64
   local.tee $7
   i64.const 32
   ...
   if
    ...
    i32.lt_u
    br_if $~CONDITION_RETURN/~lib/math/NativeMath.cos
    drop
    local.get $0
    local.get $0
    f64.mul
 ...
 (func $std/math/test_cosf (param $0 f32) (param $1 f32) (param $2 f32) (result i32)
  ...
  (local $10 i32)
  (local $11 i64)
  block $~CONDITION_RETURN/~lib/math/NativeMathf.cos (result f32)
   local.get $0
   i32.reinterpret_f32
   local.tee $7
   i32.const 2147483647
   ...
   if
    ...
    i32.const 964689920
    i32.lt_u
    br_if $~CONDITION_RETURN/~lib/math/NativeMathf.cos
    drop
    local.get $0
    f64.promote_f32
    local.tee $3
    ...
    f64.add
    f32.demote_f64
    br $~CONDITION_RETURN/~lib/math/NativeMathf.cos
   end
   local.get $7
   i32.const 31
   i32.shr_u
 ...
 (func $~lib/math/NativeMath.expm1 (param $0 f64) (result f64)
  ...
  (local $7 f64)
  (local $8 i64)
  block $~CONDITION_RETURN/~lib/math/NativeMath.expm1 (result f64)
   local.get $0
   i64.reinterpret_f64
   local.tee $8
   i64.const 32
   ...
   if
    ...
    local.get $0
    f64.ne
    br_if $~CONDITION_RETURN/~lib/math/NativeMath.expm1
    drop
    f64.const -1
    local.get $6
    br_if $~CONDITION_RETURN/~lib/math/NativeMath.expm1
   ...
   if
    ...
    f64.const -1
    f64.add
    br $~CONDITION_RETURN/~lib/math/NativeMath.expm1
   end
   local.get $0
   f64.const 1
   i64.const 1023
 ...
 (func $std/math/test_cosh (param $0 f64) (param $1 f64) (param $2 f64) (result i32)
  (local $3 i32)
  (local $4 i64)
  block $~CONDITION_RETURN/~lib/math/NativeMath.cosh (result f64)
   local.get $0
   i64.reinterpret_f64
   i64.const 9223372036854775807
   i64.and
   ...
   if
    ...
    i32.const 1045430272
    i32.lt_u
    br_if $~CONDITION_RETURN/~lib/math/NativeMath.cosh
    drop
    local.get $0
    ...
    f64.const 1
    f64.add
    br $~CONDITION_RETURN/~lib/math/NativeMath.cosh
   end
   local.get $3
 ...
 (func $~lib/math/NativeMathf.expm1 (param $0 f32) (result f32)
  ...
  (local $5 i32)
  (local $6 f32)
  block $~CONDITION_RETURN/~lib/math/NativeMathf.expm1 (result f32)
   local.get $0
   i32.reinterpret_f32
   local.tee $5
   i32.const 2147483647
   ...
   if
    ...
    i32.const 2139095040
    i32.gt_u
    br_if $~CONDITION_RETURN/~lib/math/NativeMathf.expm1
    drop
    f32.const -1
    local.get $5
    br_if $~CONDITION_RETURN/~lib/math/NativeMathf.expm1
   ...
   if
    ...
    f32.const -1
    f32.add
    br $~CONDITION_RETURN/~lib/math/NativeMathf.expm1
   end
   local.get $0
   f32.const 1
   i32.const 127
 ...
 (func $std/math/test_coshf (param $0 f32) (param $1 f32) (param $2 f32) (result i32)
  (local $3 i32)
  block $~CONDITION_RETURN/~lib/math/NativeMathf.cosh (result f32)
   local.get $0
   i32.reinterpret_f32
   i32.const 2147483647
   i32.and
   ...
   if
    ...
    i32.const 964689920
    i32.lt_u
    br_if $~CONDITION_RETURN/~lib/math/NativeMathf.cosh
    drop
    local.get $0
    ...
    f32.const 1
    f32.add
    br $~CONDITION_RETURN/~lib/math/NativeMathf.cosh
   end
   local.get $3
   i32.const 1118925335
   i32.lt_u
 ...
 (func $std/math/test_hypot (param $0 f64) (param $1 f64) (param $2 f64) (param $3 f64) (result i32)
  ...
  (local $13 f64)
  (local $14 i64)
  block $~CONDITION_RETURN/~lib/math/NativeMath.hypot (result f64)
   local.get $0
   i64.reinterpret_f64
   i64.const 9223372036854775807
   i64.and
   ...
   i32.const 2047
   i32.eq
   br_if $~CONDITION_RETURN/~lib/math/NativeMath.hypot
   drop
   local.get $5
   f64.reinterpret_i64
   local.tee $1
 ...
 (func $std/math/test_hypotf (param $0 f32) (param $1 f32) (param $2 f32) (param $3 f32) (result i32)
  ...
  (local $6 i32)
  (local $7 i32)
  block $~CONDITION_RETURN/~lib/math/NativeMathf.hypot (result f32)
   local.get $0
   i32.reinterpret_f32
   i32.const 2147483647
   i32.and
   ...
   i32.const 2139095040
   i32.eq
   br_if $~CONDITION_RETURN/~lib/math/NativeMathf.hypot
   drop
   local.get $6
   f32.reinterpret_i32
   local.tee $0
 ...
 (func $std/math/test_log10 (param $0 f64) (param $1 f64) (param $2 f64) (result i32)
  ...
  (local $10 i32)
  (local $11 f64)
  block $~CONDITION_RETURN/~lib/math/NativeMath.log10 (result f64)
   local.get $0
   i64.reinterpret_f64
   local.tee $6
   i64.const 32
   ...
   if
    ...
    i64.shl
    i64.eqz
    br_if $~CONDITION_RETURN/~lib/math/NativeMath.log10
    drop
    local.get $0
    local.get $0
    f64.sub
    ...
    if
     local.get $0
     br $~CONDITION_RETURN/~lib/math/NativeMath.log10
    else
     f64.const 0
     local.get $6
     i64.const 32
 ...
 (func $std/math/test_log10f (param $0 f32) (param $1 f32) (param $2 f32) (result i32)
  ...
  (local $9 i32)
  (local $10 f32)
  block $~CONDITION_RETURN/~lib/math/NativeMathf.log10 (result f32)
   local.get $0
   i32.reinterpret_f32
   local.tee $3
   i32.const 31
   ...
   if
    ...
    i32.shl
    i32.eqz
    br_if $~CONDITION_RETURN/~lib/math/NativeMathf.log10
    drop
    local.get $0
    local.get $0
    f32.sub
    ...
    if
     local.get $0
     br $~CONDITION_RETURN/~lib/math/NativeMathf.log10
    else
     f32.const 0
     local.get $3
     i32.const 1065353216
 ...
 (func $~lib/math/NativeMath.pow (param $0 f64) (param $1 f64) (result f64)
  ...
  (local $17 f64)
  (local $18 f64)
  block $~CONDITION_RETURN/~lib/math/NativeMath.pow (result f64)
   local.get $1
   f64.abs
   f64.const 2
   f64.le
   if
    ...
    f64.const 2
    f64.eq
    br_if $~CONDITION_RETURN/~lib/math/NativeMath.pow
    drop
    local.get $0
    f64.sqrt
    f64.abs
 ...
 (func $~lib/math/NativeMathf.pow (param $0 f32) (param $1 f32) (result f32)
  ...
  (local $7 i32)
  (local $8 i64)
  block $~CONDITION_RETURN/~lib/math/NativeMathf.pow (result f32)
   local.get $1
   f32.abs
   f32.const 2
   f32.le
   if
    ...
    f32.const 2
    f32.eq
    br_if $~CONDITION_RETURN/~lib/math/NativeMathf.pow
    drop
    local.get $0
    f32.sqrt
    f32.abs
 ...
 (func $std/math/test_rem (param $0 f64) (param $1 f64) (param $2 f64) (result i32)
  ...
  (local $8 i64)
  (local $9 f64)
  block $~CONDITION_RETURN/~lib/math/NativeMath.rem (result f64)
   local.get $1
   i64.reinterpret_f64
   local.tee $5
   i64.const 52
   ...
   if
    ...
    local.get $0
    f64.div
    br $~CONDITION_RETURN/~lib/math/NativeMath.rem
   end
   local.get $0
   local.get $8
   i64.const 1
   i64.shl
   i64.eqz
   br_if $~CONDITION_RETURN/~lib/math/NativeMath.rem
   drop
   local.get $3
   i64.eqz
   if (result i64)
 ...
 (func $std/math/test_remf (param $0 f32) (param $1 f32) (param $2 f32) (result i32)
  ...
  (local $8 i32)
  (local $9 f32)
  block $~CONDITION_RETURN/~lib/math/NativeMathf.rem (result f32)
   local.get $1
   i32.reinterpret_f32
   local.tee $5
   i32.const 23
   ...
   if
    ...
    local.get $0
    f32.div
    br $~CONDITION_RETURN/~lib/math/NativeMathf.rem
   end
   local.get $0
   local.get $8
   i32.const 1
   i32.shl
   i32.eqz
   br_if $~CONDITION_RETURN/~lib/math/NativeMathf.rem
   drop
   local.get $3
   if (result i32)
    local.get $8
 ...
 (func $~lib/math/NativeMath.sin (param $0 f64) (result f64)
  ...
  (local $8 f64)
  (local $9 f64)
  block $~CONDITION_RETURN/~lib/math/NativeMath.sin (result f64)
   local.get $0
   i64.reinterpret_f64
   local.tee $6
   i64.const 32
   ...
   if
    ...
    i32.const 1045430272
    i32.lt_u
    br_if $~CONDITION_RETURN/~lib/math/NativeMath.sin
    drop
    local.get $0
    local.get $0
    f64.mul
 ...
 (func $std/math/test_sinf (param $0 f32) (param $1 f32) (param $2 f32) (result i32)
  ...
  (local $10 i32)
  (local $11 i64)
  block $~CONDITION_RETURN/~lib/math/NativeMathf.sin (result f32)
   local.get $0
   i32.reinterpret_f32
   local.tee $8
   i32.const 2147483647
   ...
   if
    ...
    i32.const 964689920
    i32.lt_u
    br_if $~CONDITION_RETURN/~lib/math/NativeMathf.sin
    drop
    local.get $0
    f64.promote_f32
    local.tee $4
    ...
    f64.add
    f32.demote_f64
    br $~CONDITION_RETURN/~lib/math/NativeMathf.sin
   end
   local.get $8
   i32.const 31
   i32.shr_u
 ...
 (func $std/math/test_sinhf (param $0 f32) (param $1 f32) (param $2 f32) (result i32)
  ...
  (local $4 f32)
  (local $5 i32)
  block $__inlined_func$~lib/math/NativeMathf.sinh$36 (result f32)
   local.get $0
   i32.reinterpret_f32
   i32.const 2147483647
   i32.and
 ...
 (func $~lib/math/tan_kern (param $0 f64) (param $1 f64) (param $2 i32) (result f64)
  ...
  (local $6 i32)
  (local $7 i32)
  block $~CONDITION_RETURN/~lib/math/tan_kern (result f64)
   local.get $0
   i64.reinterpret_f64
   i64.const 32
   i64.shr_u
   ...
   if
    ...
    f64.sub
    f64.mul
    br $~CONDITION_RETURN/~lib/math/tan_kern
   end
   local.get $1
   local.get $2
   i32.const 1
   i32.eq
   br_if $~CONDITION_RETURN/~lib/math/tan_kern
   drop
   f64.const -1
   local.get $1
   f64.div
 ...
 (func $~lib/math/NativeMath.tan (param $0 f64) (result f64)
  ...
  (local $6 i64)
  (local $7 i32)
  block $~CONDITION_RETURN/~lib/math/NativeMath.tan (result f64)
   local.get $0
   i64.reinterpret_f64
   local.tee $6
   i64.const 32
   ...
   if
    ...
    i32.const 1044381696
    i32.lt_u
    br_if $~CONDITION_RETURN/~lib/math/NativeMath.tan
    drop
    local.get $0
    f64.const 0
    i32.const 1
 ...
 (func $std/math/test_tanf (param $0 f32) (param $1 f32) (param $2 f32) (result i32)
  ...
  (local $10 i32)
  (local $11 i64)
  block $~CONDITION_RETURN/~lib/math/NativeMathf.tan (result f32)
   local.get $0
   i32.reinterpret_f32
   local.tee $8
   i32.const 2147483647
   ...
   if
    ...
    i32.const 964689920
    i32.lt_u
    br_if $~CONDITION_RETURN/~lib/math/NativeMathf.tan
    drop
    local.get $0
    f64.promote_f32
    local.tee $4
    ...
    f64.add
    f32.demote_f64
    br $~CONDITION_RETURN/~lib/math/NativeMathf.tan
   end
   local.get $8
   i32.const 31
   i32.shr_u
 ...
 (func $std/math/test_sincos (param $0 i64)
  (local $1 f64)
  (local $2 f64)
  (local $3 i32)
  (local $4 f64)
 ...
 (func $~lib/math/ipow64 (param $0 i64) (param $1 i64) (result i64)
  (local $2 i64)
  block $~CONDITION_RETURN/~lib/math/ipow64 (result i64)
   i64.const 1
   local.set $2
   i64.const 1
   local.get $1
   ...
   i64.const 2
   i64.eq
   br_if $~CONDITION_RETURN/~lib/math/ipow64
   drop
   local.get $1
   i64.const 0
   i64.le_s
 ...
 (func $~start
  ...
  f64.const 0.6931471805599453
  global.get $std/math/JSMath.LN2
  f64.const 0
  call $std/math/check<f64>
  i32.eqz
  if
  ...
  global.get $std/math/JSMath.LN10
  f64.const 0
  call $std/math/check<f64>
  i32.eqz
  if
  ...
  f64.const 1.4426950408889634
  global.get $std/math/JSMath.LOG2E
  f64.const 0
  call $std/math/check<f64>
  i32.eqz
  if
  ...
  global.get $std/math/JSMath.SQRT1_2
  f64.const 0
  call $std/math/check<f64>
  i32.eqz
  if
  ...
  global.get $std/math/JSMath.SQRT2
  f64.const 0
  call $std/math/check<f64>
  i32.eqz
  if
