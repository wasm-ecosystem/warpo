(module
 ...
 (global $closure-capture-loop-double-init/func1 (mut i32) (i32.const 0))
 (global $closure-capture-loop-double-init/func2 (mut i32) (i32.const 0))
 ...
 (data $8 (i32.const 412) "\\\00\00\00\00\00\00\00\00\00\00\00\02\00\00\00F\00\00\00c\00l\00o\00s\00u\00r\00e\00-\00c\00a\00p\00t\00u\00r\00e\00-\00l\00o\00o\00p\00-\00d\00o\00u\00b\00l\00e\00-\00i\00n\00i\00t\00.\00t\00s\00\00\00\00\00\00\00")
 ...
 (table $0 2 2 funcref)
 (elem $0 (i32.const 1) $closure-capture-loop-double-init/outer~inner)
 (export "outer" (func $closure-capture-loop-double-init/outer))
 ...
 (func $closure-capture-loop-double-init/outer~inner (result i32)
  (local $0 i32)
  (local.set $0
 ...
 (func $closure-capture-loop-double-init/outer
  (local $0 i32)
  (local $1 i32)
  (local $i i32)
  (local $j i32)
   ...
   (if
    ...
    (then
     ...
     (if
      ...
      (then
       (global.set $closure-capture-loop-double-init/func1
        (local.get $inner)
       )
      )
      (else
       (global.set $closure-capture-loop-double-init/func2
        (local.get $inner)
       )
      )
     )
 ...
 (func $start:closure-capture-loop-double-init
  (local $0 i32)
  (local $1 i32)
  (local $2 i32)
  (local $3 i32)
  ...
  (block
   ...
   (call $closure-capture-loop-double-init/outer)
  )
  (if
   (i32.eqz
    (i32.ne
     (global.get $closure-capture-loop-double-init/func1)
     (i32.const 0)
    )
   )
   (then
  ...
  (if
   (i32.eqz
    (i32.ne
     (global.get $closure-capture-loop-double-init/func2)
     (i32.const 0)
    )
   )
   (then
 ...
 (func $~start
  (call $start:closure-capture-loop-double-init)
 )
)
