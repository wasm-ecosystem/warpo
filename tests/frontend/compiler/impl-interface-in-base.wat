(module
 ...
 (func $impl-interface-in-base/impl_interface_in_base.Base#constructor (param $this i32) (result i32)
  (if
   (i32.eqz
    (local.get $this)
   )
 ...
 (func $impl-interface-in-base/impl_interface_in_base.C#constructor (param $this i32) (result i32)
  (if
   (i32.eqz
    (local.get $this)
   )
  ...
  (local.set $this
   (call $~lib/rt/__localtostack
    (call $impl-interface-in-base/impl_interface_in_base.Base#constructor
     (call $~lib/rt/__tmptostack
      (local.get $this)
     )
    )
 ...
 (func $impl-interface-in-base/impl_interface_in_base.I#foo (param $this i32) (result i32)
  (unreachable)
 )
 (func $impl-interface-in-base/impl_interface_in_base.test
  (local $i i32)
  (local.set $i
   (call $~lib/rt/__localtostack
    (call $impl-interface-in-base/impl_interface_in_base.C#constructor
     (i32.const 0)
    )
   )
  )
  (if
   (i32.eqz
    (i32.eq
     (call $impl-interface-in-base/impl_interface_in_base.I#foo@override
      (call $~lib/rt/__tmptostack
       (local.get $i)
      )
     )
 ...
 (func $start:impl-interface-in-base
  ...
  (call $impl-interface-in-base/impl_interface_in_base.test)
 )
 (func $impl-interface-in-base/impl_interface_in_base.Base#foo (param $this i32) (result i32)
  (return
   (i32.const 42)
  )
 )
 (func $impl-interface-in-base/impl_interface_in_base.I#foo@override (param $0 i32) (result i32)
  (local $1 i32)
  (block $default
   (block $case0
    (local.set $1
   ...
   (return
    (call $impl-interface-in-base/impl_interface_in_base.Base#foo
     (local.get $0)
    )
   )
  )
