(module
 ...
 (data $8 (i32.const 412) "L\00\00\00\00\00\00\00\00\00\00\00\02\00\00\008\00\00\00c\00l\00o\00s\00u\00r\00e\00-\00l\00o\00o\00p\00-\00e\00a\00r\00l\00y\00-\00r\00e\00t\00u\00r\00n\00.\00t\00s\00\00\00\00\00")
 ...
 (func $closure-loop-early-return/loopEarlyReturn (param $n i32) (param $flag i32) (result i32)
  (local $2 i32)
  (local $x i32)
  (local $inner i32)
  (local.set $2
 ...
 (func $closure-loop-early-return/loopUseAndEarlyReturn (param $n i32) (param $flag i32) (result i32)
  (local $2 i32)
  (local $x i32)
  (local $inner i32)
  (local.set $2
 ...
 (func $start:closure-loop-early-return
  (global.set $~lib/rt/itcms/threshold
   (i32.shr_u
    (i32.sub
     (i32.shl
   ...
   (i32.eqz
    (i32.eq
     (block (result i32)
      ...
      (call $closure-loop-early-return/loopEarlyReturn
       (i32.const 3)
       (i32.const 1)
      )
     )
   ...
   (i32.eqz
    (i32.eq
     (block (result i32)
      ...
      (call $closure-loop-early-return/loopUseAndEarlyReturn
       (i32.const 3)
       (i32.const 1)
      )
     )
 ...
 (func $~start
  (call $start:closure-loop-early-return)
 )
)
