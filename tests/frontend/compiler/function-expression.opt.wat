(module
 ...
 (data $1 (i32.const 44) "<")
 (data $1.1 (i32.const 56) "\02\00\00\00,\00\00\00f\00u\00n\00c\00t\00i\00o\00n\00-\00e\00x\00p\00r\00e\00s\00s\00i\00o\00n\00.\00t\00s\00\1c")
 (data $2.1 (i32.const 120) "\04\00\00\00\08\00\00\00\02")
 (data $3 (i32.const 140) "\1c")
 (data $3.1 (i32.const 152) "\05\00\00\00\08\00\00\00\03")
 (data $4 (i32.const 172) "\1c")
 (data $4.1 (i32.const 184) "\06\00\00\00\08\00\00\00\04")
 (data $5 (i32.const 204) "\1c")
 (data $5.1 (i32.const 216) "\07\00\00\00\08\00\00\00\05")
 (data $6 (i32.const 236) "\1c")
 (data $6.1 (i32.const 248) "\07\00\00\00\08\00\00\00\06")
 (data $7 (i32.const 268) "\1c")
 (data $7.1 (i32.const 280) "\07\00\00\00\08\00\00\00\07")
 (data $8 (i32.const 300) "\1c")
 (data $8.1 (i32.const 312) "\07\00\00\00\08\00\00\00\08")
 (data $9 (i32.const 332) "\1c")
 (data $9.1 (i32.const 344) "\07\00\00\00\08\00\00\00\t")
 (data $10 (i32.const 364) "\1c")
 (data $10.1 (i32.const 376) "\07\00\00\00\08\00\00\00\n")
 (data $11 (i32.const 396) "\1c")
 (data $11.1 (i32.const 408) "\06\00\00\00\08\00\00\00\0b")
 (data $12 (i32.const 428) "\1c")
 (data $12.1 (i32.const 440) "\04\00\00\00\08\00\00\00\0c")
 (data $13 (i32.const 460) "\1c")
 (data $13.1 (i32.const 472) "\08\00\00\00\08\00\00\00\r")
 (data $14 (i32.const 492) "\1c")
 (data $14.1 (i32.const 504) "\04\00\00\00\08\00\00\00\0e")
 (data $15 (i32.const 524) "\1c")
 (data $15.1 (i32.const 536) "\08\00\00\00\08\00\00\00\0f")
 (data $16 (i32.const 556) "<")
 (data $16.1 (i32.const 568) "\02\00\00\00 \00\00\00~\00l\00i\00b\00/\00r\00t\00/\00i\00t\00c\00m\00s\00.\00t\00s")
 (data $18 (i32.const 652) "<")
 (data $18.1 (i32.const 664) "\02\00\00\00$\00\00\00I\00n\00d\00e\00x\00 \00o\00u\00t\00 \00o\00f\00 \00r\00a\00n\00g\00e")
 (data $19 (i32.const 716) ",")
 (data $19.1 (i32.const 728) "\02\00\00\00\14\00\00\00~\00l\00i\00b\00/\00r\00t\00.\00t\00s")
 (data $20 (i32.const 764) "<")
 (data $20.1 (i32.const 776) "\02\00\00\00(\00\00\00A\00l\00l\00o\00c\00a\00t\00i\00o\00n\00 \00t\00o\00o\00 \00l\00a\00r\00g\00e")
 (data $23 (i32.const 892) "<")
 (data $23.1 (i32.const 904) "\02\00\00\00\1e\00\00\00~\00l\00i\00b\00/\00r\00t\00/\00t\00l\00s\00f\00.\00t\00s")
 (data $24 (i32.const 956) "\1c")
 (data $24.1 (i32.const 968) "\04\00\00\00\08\00\00\00\10")
 (data $25 (i32.const 988) "\1c")
 (data $25.1 (i32.const 1000) "\08\00\00\00\08\00\00\00\11")
 (data $26 (i32.const 1020) "\1c")
 (data $26.1 (i32.const 1032) "\04\00\00\00\08\00\00\00\12")
 (data $27 (i32.const 1052) "\1c")
 (data $27.1 (i32.const 1064) "\04\00\00\00\08\00\00\00\13")
 ...
 (func $~start
  ...
  call $start:function-expression~someName|2
