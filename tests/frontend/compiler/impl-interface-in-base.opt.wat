(module
 ...
 (func $~start
  ...
  i32.const 320
  global.set $~lib/rt/itcms/fromSpace
  block $__inlined_func$impl-interface-in-base/impl_interface_in_base.I#foo@override$74 (result i32)
   global.get $~lib/memory/__stack_pointer
   i32.const 4
   i32.sub
   ...
   i32.eq
   i32.or
   br_if $__inlined_func$impl-interface-in-base/impl_interface_in_base.I#foo@override$74
   drop
   unreachable
  end
  i32.const 42
