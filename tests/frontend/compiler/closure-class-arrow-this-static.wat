(module
 ...
 (global $closure-class-arrow-this-static/FromStatic.value (mut i32) (i32.const 0))
 ...
 (data $8 (i32.const 412) "\\\00\00\00\00\00\00\00\00\00\00\00\02\00\00\00D\00\00\00c\00l\00o\00s\00u\00r\00e\00-\00c\00l\00a\00s\00s\00-\00a\00r\00r\00o\00w\00-\00t\00h\00i\00s\00-\00s\00t\00a\00t\00i\00c\00.\00t\00s\00\00\00\00\00\00\00\00\00")
 (data $9 (i32.const 512) "\06\00\00\00 \00\00\00 \00\00\00 \00\00\00\00\00\00\00\00\00\00\00\00\00\00\00")
 (table $0 2 2 funcref)
 (elem $0 (i32.const 1) $closure-class-arrow-this-static/FromStatic.run~anonymous|0)
 ...
 (func $closure-class-arrow-this-static/FromStatic.run~anonymous|0 (result i32)
  (local $0 i32)
  (local.set $0
 ...
 (func $closure-class-arrow-this-static/FromStatic.run (result i32)
  (local $0 i32)
  (local $getValue i32)
  (local.set $0
   (call $~lib/rt/__localtostack
 ...
 (func $start:closure-class-arrow-this-static
  (global.set $closure-class-arrow-this-static/FromStatic.value
   (i32.const 50)
  )
  (global.set $~lib/rt/itcms/threshold
   (i32.shr_u
   ...
   (i32.eqz
    (i32.eq
     (block (result i32)
      ...
      (call $closure-class-arrow-this-static/FromStatic.run)
     )
     (i32.const 50)
    )
   )
 ...
 (func $~start
  (call $start:closure-class-arrow-this-static)
 )
)
