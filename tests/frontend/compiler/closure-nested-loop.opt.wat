(module
 ...
 (data $8.1 (i32.const 424) "\02\00\00\00,\00\00\00c\00l\00o\00s\00u\00r\00e\00-\00n\00e\00s\00t\00e\00d\00-\00l\00o\00o\00p\00.\00t\00s\00\00\00\00\00\06\00\00\00 \00\00\00 \00\00\00 ")
 (table $0 4 4 funcref)
 (elem $0 (i32.const 1) $closure-nested-loop/loopAccess~inner $closure-nested-loop/loopMultiLevel~middle~inner $closure-nested-loop/loopMultiLevel~middle)
 (export "loopAccess" (func $closure-nested-loop/loopAccess))
 (export "loopMultiLevel" (func $closure-nested-loop/loopMultiLevel))
 ...
 (func $closure-nested-loop/loopAccess~inner (result i32)
  (local $0 i32)
  (local $1 i32)
  (local $2 i32)
  (local $3 i32)
 ...
 (func $~lib/rt/__newFunction (param $0 i32) (param $1 i32) (result i32)
  (local $2 i32)
  i32.const 8
  i32.const 5
  call $~lib/rt/itcms/__new
 ...
 (func $closure-nested-loop/loopAccess (param $0 i32) (param $1 i32) (result i32)
  (local $2 i32)
  (local $3 i32)
  i32.const 16
  call $~lib/rt/__newTuple
 ...
 (func $closure-nested-loop/loopMultiLevel~middle~inner (result i32)
  (local $0 i32)
  (local $1 i32)
  (local $2 i32)
  (local $3 i32)
 ...
 (func $closure-nested-loop/loopMultiLevel~middle (result i32)
  (local $0 i32)
  i32.const 8
  call $~lib/rt/__newTuple
  local.tee $0
 ...
 (func $closure-nested-loop/loopMultiLevel (param $0 i32) (result i32)
  (local $1 i32)
  i32.const 8
  call $~lib/rt/__newTuple
  local.tee $1
 ...
 (func $~start
  ...
  i32.const 2
  i32.const 3
  call $closure-nested-loop/loopAccess
  i32.const 18
  i32.ne
  if
   i32.const 0
  ...
  global.set $~lib/rt/closure/env
  i32.const 3
  call $closure-nested-loop/loopMultiLevel
  i32.const 24
  i32.ne
  if
   i32.const 0
