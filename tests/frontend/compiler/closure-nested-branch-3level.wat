(module
 ...
 (data $8 (i32.const 412) "\\\00\00\00\00\00\00\00\00\00\00\00\02\00\00\00>\00\00\00c\00l\00o\00s\00u\00r\00e\00-\00n\00e\00s\00t\00e\00d\00-\00b\00r\00a\00n\00c\00h\00-\003\00l\00e\00v\00e\00l\00.\00t\00s\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00")
 (data $9 (i32.const 512) "\06\00\00\00 \00\00\00 \00\00\00 \00\00\00\00\00\00\00\00\00\00\00\00\00\00\00")
 (table $0 4 4 funcref)
 (elem $0 (i32.const 1) $closure-nested-branch-3level/threeLevel~level1~level2~level3 $closure-nested-branch-3level/threeLevel~level1~level2 $closure-nested-branch-3level/threeLevel~level1)
 (export "threeLevel" (func $closure-nested-branch-3level/threeLevel))
 ...
 (func $closure-nested-branch-3level/threeLevel~level1~level2~level3 (result i32)
  (local $0 i32)
  (local $base i32)
  (local.set $0
 ...
 (func $closure-nested-branch-3level/threeLevel~level1~level2 (result i32)
  (local $0 i32)
  (local $z i32)
  (local $level3 i32)
  (local.set $0
 ...
 (func $closure-nested-branch-3level/threeLevel~level1 (result i32)
  (local $0 i32)
  (local $y i32)
  (local $level2 i32)
  (local.set $0
 ...
 (func $closure-nested-branch-3level/threeLevel (param $a i32) (param $b i32) (param $flag i32) (result i32)
  (local $3 i32)
  (local $x i32)
  (local $w i32)
  (local $level1 i32)
 ...
 (func $start:closure-nested-branch-3level
  (global.set $~lib/rt/itcms/threshold
   (i32.shr_u
    (i32.sub
     (i32.shl
   ...
   (i32.eqz
    (i32.eq
     (block (result i32)
      ...
      (call $closure-nested-branch-3level/threeLevel
       (i32.const 5)
       (i32.const 2)
       (i32.const 1)
      )
 ...
 (func $~start
  (call $start:closure-nested-branch-3level)
 )
)
