(module
 ...
 (global $closure-capture-for-no-incrementor/first (mut i32) (i32.const 0))
 (global $closure-capture-for-no-incrementor/second (mut i32) (i32.const 0))
 ...
 (data $8 (i32.const 412) "\\\00\00\00\00\00\00\00\00\00\00\00\02\00\00\00J\00\00\00c\00l\00o\00s\00u\00r\00e\00-\00c\00a\00p\00t\00u\00r\00e\00-\00f\00o\00r\00-\00n\00o\00-\00i\00n\00c\00r\00e\00m\00e\00n\00t\00o\00r\00.\00t\00s\00\00\00")
 ...
 (table $0 2 2 funcref)
 (elem $0 (i32.const 1) $closure-capture-for-no-incrementor/outer~inner)
 (export "outer" (func $closure-capture-for-no-incrementor/outer))
 ...
 (func $closure-capture-for-no-incrementor/outer~inner (result i32)
  (local $0 i32)
  (local.set $0
 ...
 (func $closure-capture-for-no-incrementor/outer
  (local $0 i32)
  (local $1 i32)
  (local $value i32)
  (local $inner i32)
 ...
 (func $start:closure-capture-for-no-incrementor
  (local $0 i32)
  (local $1 i32)
  (local $2 i32)
  (local $3 i32)
  ...
  (block
   ...
   (call $closure-capture-for-no-incrementor/outer)
  )
  (if
   (i32.eqz
    (i32.ne
     (global.get $closure-capture-for-no-incrementor/first)
     (i32.const 0)
    )
   )
   (then
  ...
  (if
   (i32.eqz
    (i32.ne
     (global.get $closure-capture-for-no-incrementor/second)
     (i32.const 0)
    )
   )
   (then
 ...
 (func $~start
  (call $start:closure-capture-for-no-incrementor)
 )
)
