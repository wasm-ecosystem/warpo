(module
 ...
 (data $8 (i32.const 412) "L\00\00\00\00\00\00\00\00\00\00\00\02\00\00\00.\00\00\00c\00l\00o\00s\00u\00r\00e\00-\00p\00a\00r\00a\00m\00-\00n\00e\00s\00t\00e\00d\00.\00t\00s\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00")
 (data $9 (i32.const 496) "\07\00\00\00 \00\00\00 \00\00\00 \00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00")
 (table $0 3 3 funcref)
 (elem $0 (i32.const 1) $closure-param-nested/level0~level1~level2 $closure-param-nested/level0~level1)
 (export "level0" (func $closure-param-nested/level0))
 ...
 (func $closure-param-nested/level0~level1~level2 (result i32)
  (local $0 i32)
  (local.set $0
 ...
 (func $closure-param-nested/level0~level1 (param $b i32) (result i32)
  (local $1 i32)
  (local $level2 i32)
  (local.set $1
   (call $~lib/rt/__localtostack
 ...
 (func $closure-param-nested/level0 (param $a i32) (result i32)
  (local $1 i32)
  (local $level1 i32)
  (local.set $1
   (call $~lib/rt/__localtostack
 ...
 (func $start:closure-param-nested
  (global.set $~lib/rt/itcms/threshold
   (i32.shr_u
    (i32.sub
     (i32.shl
   ...
   (i32.eqz
    (i32.eq
     (block (result i32)
      ...
      (call $closure-param-nested/level0
       (i32.const 5)
      )
     )
     (i32.const 15)
 ...
 (func $~start
  (call $start:closure-param-nested)
 )
)
