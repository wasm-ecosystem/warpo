(module
 ...
 (data $9 (i32.const 444) "\\\00\00\00\00\00\00\00\00\00\00\00\02\00\00\00>\00\00\00c\00l\00o\00s\00u\00r\00e\00-\00c\00a\00p\00t\00u\00r\00e\00-\00f\00o\00r\00-\00o\00f\00-\00m\00i\00x\00e\00d\00.\00t\00s\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00")
 ...
 (data $11 (i32.const 672) "\0b\00\00\00 \00\00\00 \00\00\00 \00\00\00\00\00\00\00\00\00\00\00\02\t\00\00 \00\00\00\00\00\00\00 \00\00\00 \00\00\00\00\00\00\00")
 (table $0 3 3 funcref)
 (elem $0 (i32.const 1) $closure-capture-for-of-mixed/outer~innerA $closure-capture-for-of-mixed/outer~innerB)
 ...
 (func $closure-capture-for-of-mixed/outer~innerA (result i32)
  (local $0 i32)
  (local.set $0
   (call $~lib/rt/__localtostack
 ...
 (func $closure-capture-for-of-mixed/outer~innerB (result i32)
  (local $0 i32)
  (local.set $0
   (call $~lib/rt/__localtostack
    (call $~lib/rt/__newTuple
 ...
 (func $closure-capture-for-of-mixed/outer
  (local $0 i32)
  (local $x i32)
  (local $2 i32)
  (local $arr i32)
 ...
 (func $start:closure-capture-for-of-mixed
  (local $0 i32)
  (local $1 i32)
  (local $2 i32)
  (local $3 i32)
  ...
  (block
   ...
   (call $closure-capture-for-of-mixed/outer)
  )
  (if
   (i32.eqz
    (i32.ne
     (global.get $closure-capture-for-of-mixed/funcA1)
     (i32.const 0)
    )
   )
   (then
  ...
  (if
   (i32.eqz
    (i32.ne
     (global.get $closure-capture-for-of-mixed/funcB1)
     (i32.const 0)
    )
   )
   (then
  ...
  (if
   (i32.eqz
    (i32.ne
     (global.get $closure-capture-for-of-mixed/funcB2)
     (i32.const 0)
    )
   )
   (then
 ...
 (func $~start
  (call $start:closure-capture-for-of-mixed)
 )
)
