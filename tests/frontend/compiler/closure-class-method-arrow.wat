(module
 ...
 (data $8 (i32.const 412) "L\00\00\00\00\00\00\00\00\00\00\00\02\00\00\00:\00\00\00c\00l\00o\00s\00u\00r\00e\00-\00c\00l\00a\00s\00s\00-\00m\00e\00t\00h\00o\00d\00-\00a\00r\00r\00o\00w\00.\00t\00s\00\00\00")
 (data $9 (i32.const 496) "\07\00\00\00 \00\00\00 \00\00\00 \00\00\00\00\00\00\00 \00\00\00\00\00\00\00\00\00\00\00")
 (table $0 2 2 funcref)
 (elem $0 (i32.const 1) $closure-class-method-arrow/Adder#run~anonymous|0)
 (export "test" (func $closure-class-method-arrow/test))
 (export "memory" (memory $0))
 (start $~start)
 (func $~lib/object/Object#constructor (param $this i32) (result i32)
  (local.get $this)
 )
 (func $closure-class-method-arrow/Adder#constructor (param $this i32) (result i32)
  (local.set $this
 ...
 (func $closure-class-method-arrow/Adder#set:base (param $this i32) (param $base i32)
  (i32.store
   (local.get $this)
   (local.get $base)
  )
 ...
 (func $closure-class-method-arrow/Adder#run~anonymous|0
  (local $0 i32)
  (local.set $0
   (call $~lib/rt/__localtostack
 ...
 (func $closure-class-method-arrow/Adder#get:base (param $this i32) (result i32)
  (i32.load
   (local.get $this)
  )
 )
 (func $closure-class-method-arrow/Adder#run (param $this i32) (result i32)
  (local $1 i32)
  (local $offset i32)
  (local $modify i32)
  (local.set $1
  ...
  (return
   (i32.add
    (call $closure-class-method-arrow/Adder#get:base
     (call $~lib/rt/__tmptostack
      (local.get $this)
     )
    )
 ...
 (func $closure-class-method-arrow/test (result i32)
  (local $a i32)
  (local.set $a
   (call $~lib/rt/__localtostack
    (call $closure-class-method-arrow/Adder#constructor
     (call $~lib/rt/__tmptostack
      (call $~lib/rt/itcms/__new
       (i32.const 4)
       (i32.const 4)
  ...
  (call $closure-class-method-arrow/Adder#set:base
   (call $~lib/rt/__tmptostack
    (local.get $a)
   )
   (i32.const 5)
  ...
  (return
   (block (result i32)
    ...
    (call $closure-class-method-arrow/Adder#run
     (call $~lib/rt/__tmptostack
      (local.get $a)
     )
    )
 ...
 (func $start:closure-class-method-arrow
  (global.set $~lib/rt/itcms/threshold
   (i32.shr_u
    (i32.sub
     (i32.shl
  ...
  (if
   (i32.eqz
    (i32.eq
     (call $closure-class-method-arrow/test)
     (i32.const 16)
    )
   )
   (then
  ...
  (block $invalid
   (block $~lib/function/Function<%28%29=>void>
    (block $~lib/tuple/SmallTuple
     (block $closure-class-method-arrow/Adder
      (block $~lib/arraybuffer/ArrayBufferView
       (block $~lib/string/String
        (block $~lib/arraybuffer/ArrayBuffer
         (block $~lib/object/Object
          (br_table $~lib/object/Object $~lib/arraybuffer/ArrayBuffer $~lib/string/String $~lib/arraybuffer/ArrayBufferView $closure-class-method-arrow/Adder $~lib/tuple/SmallTuple $~lib/function/Function<%28%29=>void> $invalid
           (i32.load
            (i32.sub
             (local.get $0)
             (i32.const 8)
 ...
 (func $~start
  (call $start:closure-class-method-arrow)
 )
)
