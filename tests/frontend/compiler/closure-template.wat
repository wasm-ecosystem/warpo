(module
 ...
 (data $8 (i32.const 412) "<\00\00\00\00\00\00\00\00\00\00\00\02\00\00\00&\00\00\00c\00l\00o\00s\00u\00r\00e\00-\00t\00e\00m\00p\00l\00a\00t\00e\00.\00t\00s\00\00\00\00\00\00\00")
 (data $9 (i32.const 480) "\07\00\00\00 \00\00\00 \00\00\00 \00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00")
 (table $0 3 3 funcref)
 (elem $0 (i32.const 1) $closure-template/outer<i32>~inner $closure-template/outer<f32>~inner)
 ...
 (func $closure-template/outer<i32>~inner (result i32)
  (local $0 i32)
  (local.set $0
 ...
 (func $closure-template/outer<i32> (param $x i32) (result i32)
  (local $1 i32)
  (local $val i32)
  (local $inner i32)
  (local.set $1
 ...
 (func $~lib/tuple/SmallTuple#__set<f32> (param $this i32) (param $offset i32) (param $value f32)
  (local $elementPtr i32)
  (local.set $elementPtr
   (i32.add
    (local.get $this)
 ...
 (func $~lib/tuple/SmallTuple#__get<f32> (param $this i32) (param $offset i32) (result f32)
  (local $elementPtr i32)
  (local.set $elementPtr
   (i32.add
    (local.get $this)
 ...
 (func $closure-template/outer<f32>~inner (result f32)
  (local $0 i32)
  (local.set $0
   (call $~lib/rt/__localtostack
    (call $~lib/rt/__newTuple
 ...
 (func $closure-template/outer<f32> (param $x f32) (result f32)
  (local $1 i32)
  (local $val f32)
  (local $inner i32)
  (local.set $1
   ...
   (i32.eqz
    (i32.eq
     (block (result i32)
      ...
      (call $closure-template/outer<i32>
       (i32.const 42)
      )
     )
     (i32.const 42)
   ...
   (i32.eqz
    (f32.eq
     (block (result f32)
      ...
      (call $closure-template/outer<f32>
       (f32.const 42)
      )
     )
     (f32.const 42)
       ...
       (block $~lib/string/String
        (block $~lib/arraybuffer/ArrayBuffer
         (block $~lib/object/Object
          (br_table $~lib/object/Object $~lib/arraybuffer/ArrayBuffer $~lib/string/String $~lib/arraybuffer/ArrayBufferView $~lib/tuple/SmallTuple $~lib/function/Function<%28%29=>i32> $~lib/function/Function<%28%29=>f32> $invalid
           (i32.load
            (i32.sub
             (local.get $0)
             (i32.const 8)
