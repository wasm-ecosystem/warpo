(module
 ...
 (data $8 (i32.const 412) "L\00\00\00\00\00\00\00\00\00\00\00\02\00\00\000\00\00\00c\00l\00o\00s\00u\00r\00e\00-\00o\00b\00j\00-\00a\00t\00t\00r\00i\00b\00u\00t\00e\00.\00t\00s\00\00\00\00\00\00\00\00\00\00\00\00\00")
 (data $9 (i32.const 496) "\07\00\00\00 \00\00\00 \00\00\00 \00\00\00\00\00\00\00\00\00\00\00 \00\00\00\00\00\00\00")
 (table $0 2 2 funcref)
 (elem $0 (i32.const 1) $closure-obj-attribute/outer~modify)
 (export "outer" (func $closure-obj-attribute/outer))
 (export "memory" (memory $0))
 (start $~start)
 (func $~lib/object/Object#constructor (param $this i32) (result i32)
  (local.get $this)
 )
 (func $closure-obj-attribute/Point#constructor (param $this i32) (result i32)
  (local.set $this
 ...
 (func $~lib/tuple/SmallTuple#__set<closure-obj-attribute/Point> (param $this i32) (param $offset i32) (param $value i32)
 ...
 (func $~lib/tuple/SmallTuple#__get<closure-obj-attribute/Point> (param $this i32) (param $offset i32) (result i32)
  (local $elementPtr i32)
  (local.set $elementPtr
   (i32.add
    (local.get $this)
 ...
 (func $closure-obj-attribute/Point#set:x (param $this i32) (param $x i32)
  (i32.store
   (local.get $this)
   (local.get $x)
  )
 )
 (func $closure-obj-attribute/Point#set:y (param $this i32) (param $y i32)
  (i32.store offset=4
   (local.get $this)
   (local.get $y)
  )
 )
 (func $closure-obj-attribute/Point#get:x (param $this i32) (result i32)
  (i32.load
   (local.get $this)
  )
 )
 (func $closure-obj-attribute/Point#get:y (param $this i32) (result i32)
  (i32.load offset=4
   (local.get $this)
  )
 )
 ...
 (func $closure-obj-attribute/outer~modify
  ...
  (call $closure-obj-attribute/Point#set:x
   ...
   (i32.add
    (call $closure-obj-attribute/Point#get:x
     (call $~lib/rt/__tmptostack
      (call $~lib/tuple/SmallTuple#__get<closure-obj-attribute/Point>
       (call $~lib/rt/__tmptostack
        (call $~lib/rt/closure/getClosureEnvByLevel
  ...
  (call $closure-obj-attribute/Point#set:y
   (call $~lib/rt/__tmptostack
    (call $~lib/tuple/SmallTuple#__get<closure-obj-attribute/Point>
     (call $~lib/rt/__tmptostack
      (call $~lib/rt/closure/getClosureEnvByLevel
   ...
   (i32.add
    (call $closure-obj-attribute/Point#get:y
     (call $~lib/rt/__tmptostack
      (call $~lib/tuple/SmallTuple#__get<closure-obj-attribute/Point>
       (call $~lib/rt/__tmptostack
        (call $~lib/rt/closure/getClosureEnvByLevel
 ...
 (func $closure-obj-attribute/outer (result i32)
  (local $0 i32)
  (local $obj i32)
  (local $modify i32)
  (local.set $0
  ...
  (call $~lib/tuple/SmallTuple#__set<closure-obj-attribute/Point>
   ...
   (i32.const 4)
   (call $~lib/rt/__tmptostack
    (call $closure-obj-attribute/Point#constructor
     (call $~lib/rt/__tmptostack
      (call $~lib/rt/itcms/__new
       (i32.const 8)
       (i32.const 5)
 ...
 (func $start:closure-obj-attribute
  (global.set $~lib/rt/itcms/threshold
   (i32.shr_u
    (i32.sub
     (i32.shl
   ...
   (i32.eqz
    (i32.eq
     (block (result i32)
      ...
      (call $closure-obj-attribute/outer)
     )
     (i32.const 33)
    )
   )
 ...
 (func $~lib/rt/__visit_members (param $0 i32) (param $1 i32)
  (block $invalid
   (block $~lib/function/Function<%28%29=>void>
    (block $closure-obj-attribute/Point
     (block $~lib/tuple/SmallTuple
      (block $~lib/arraybuffer/ArrayBufferView
       (block $~lib/string/String
        (block $~lib/arraybuffer/ArrayBuffer
         (block $~lib/object/Object
          (br_table $~lib/object/Object $~lib/arraybuffer/ArrayBuffer $~lib/string/String $~lib/arraybuffer/ArrayBufferView $~lib/tuple/SmallTuple $closure-obj-attribute/Point $~lib/function/Function<%28%29=>void> $invalid
           (i32.load
            (i32.sub
             (local.get $0)
             (i32.const 8)
 ...
 (func $~start
  (call $start:closure-obj-attribute)
 )
)
