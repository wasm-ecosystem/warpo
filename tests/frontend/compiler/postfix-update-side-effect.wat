(module
 ...
 (global $postfix-update-side-effect/first (mut i32) (i32.const 0))
 (global $postfix-update-side-effect/second (mut i32) (i32.const 0))
 (global $postfix-update-side-effect/receiverCalls (mut i32) (i32.const 0))
 ...
 (data $8 (i32.const 412) "L\00\00\00\00\00\00\00\00\00\00\00\02\00\00\00:\00\00\00p\00o\00s\00t\00f\00i\00x\00-\00u\00p\00d\00a\00t\00e\00-\00s\00i\00d\00e\00-\00e\00f\00f\00e\00c\00t\00.\00t\00s\00\00\00")
 (data $9 (i32.const 496) "\05\00\00\00 \00\00\00 \00\00\00 \00\00\00\00\00\00\00 \00\00\00")
 (table $0 1 1 funcref)
 (elem $0 (i32.const 1))
 ...
 (func $postfix-update-side-effect/Box#constructor (param $this i32) (result i32)
  (local.set $this
 ...
 (func $postfix-update-side-effect/receiver (result i32)
  (global.set $postfix-update-side-effect/receiverCalls
   (i32.add
    (global.get $postfix-update-side-effect/receiverCalls)
    (i32.const 1)
   )
  )
  (return
   (if (result i32)
    ...
    (then
     (global.get $postfix-update-side-effect/first)
    )
    (else
     (global.get $postfix-update-side-effect/second)
    )
   )
  )
 )
 (func $postfix-update-side-effect/Box#get:value (param $this i32) (result i32)
  (i32.load
   (local.get $this)
  )
 )
 (func $postfix-update-side-effect/Box#set:value (param $this i32) (param $value i32)
  (i32.store
   (local.get $this)
   (local.get $value)
  )
 )
 (func $start:postfix-update-side-effect
  (local $0 i32)
  (global.set $~lib/rt/itcms/threshold
   (i32.shr_u
    (i32.sub
  ...
  (global.set $postfix-update-side-effect/first
   (call $postfix-update-side-effect/Box#constructor
    (call $~lib/rt/__tmptostack
  ...
  (global.set $postfix-update-side-effect/second
   (call $postfix-update-side-effect/Box#constructor
    (call $~lib/rt/__tmptostack
     (call $~lib/rt/itcms/__new
      (i32.const 4)
  ...
  (block
   (local.set $0
    (call $~lib/rt/__localtostack
     (call $postfix-update-side-effect/receiver)
    )
   )
   (call $postfix-update-side-effect/Box#set:value
    (call $~lib/rt/__tmptostack
     (local.get $0)
    )
    (i32.add
     (call $postfix-update-side-effect/Box#get:value
      (call $~lib/rt/__tmptostack
       (local.get $0)
      )
     )
 ...
 (func $~lib/rt/__visit_members (param $0 i32) (param $1 i32)
  (block $invalid
   (block $postfix-update-side-effect/Box
    (block $~lib/arraybuffer/ArrayBufferView
     (block $~lib/string/String
      (block $~lib/arraybuffer/ArrayBuffer
       (block $~lib/object/Object
        (br_table $~lib/object/Object $~lib/arraybuffer/ArrayBuffer $~lib/string/String $~lib/arraybuffer/ArrayBufferView $postfix-update-side-effect/Box $invalid
         (i32.load
          (i32.sub
           (local.get $0)
           (i32.const 8)
 ...
 (func $~start
  (call $start:postfix-update-side-effect)
 )
)
