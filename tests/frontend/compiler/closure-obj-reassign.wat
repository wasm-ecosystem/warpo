(module
 ...
 (data $8 (i32.const 412) "L\00\00\00\00\00\00\00\00\00\00\00\02\00\00\00.\00\00\00c\00l\00o\00s\00u\00r\00e\00-\00o\00b\00j\00-\00r\00e\00a\00s\00s\00i\00g\00n\00.\00t\00s\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00")
 (data $9 (i32.const 496) "\07\00\00\00 \00\00\00 \00\00\00 \00\00\00\00\00\00\00\00\00\00\00 \00\00\00\00\00\00\00")
 (table $0 2 2 funcref)
 (elem $0 (i32.const 1) $closure-obj-reassign/outer~reassign)
 (export "outer" (func $closure-obj-reassign/outer))
 (export "memory" (memory $0))
 (start $~start)
 (func $~lib/object/Object#constructor (param $this i32) (result i32)
  (local.get $this)
 )
 (func $closure-obj-reassign/Box#constructor (param $this i32) (result i32)
  (local.set $this
 ...
 (func $~lib/tuple/SmallTuple#__set<closure-obj-reassign/Box> (param $this i32) (param $offset i32) (param $value i32)
 ...
 (func $~lib/tuple/SmallTuple#__get<closure-obj-reassign/Box> (param $this i32) (param $offset i32) (result i32)
  (local $elementPtr i32)
  (local.set $elementPtr
   (i32.add
    (local.get $this)
 ...
 (func $closure-obj-reassign/Box#set:value (param $this i32) (param $value i32)
  (i32.store
   (local.get $this)
   (local.get $value)
  )
 ...
 (func $closure-obj-reassign/outer~reassign
  (local $0 i32)
  (local $newObj i32)
  (local.set $0
   (call $~lib/rt/__localtostack
  ...
  (local.set $newObj
   (call $~lib/rt/__localtostack
    (call $closure-obj-reassign/Box#constructor
     (call $~lib/rt/__tmptostack
      (call $~lib/rt/itcms/__new
       (i32.const 4)
       (i32.const 5)
  ...
  (call $closure-obj-reassign/Box#set:value
   (call $~lib/rt/__tmptostack
    (local.get $newObj)
   )
   (i32.const 42)
 ...
 (func $closure-obj-reassign/Box#get:value (param $this i32) (result i32)
  (i32.load
   (local.get $this)
  )
 )
 (func $closure-obj-reassign/outer (result i32)
  (local $0 i32)
  (local $obj i32)
  (local $reassign i32)
  (local.set $0
  ...
  (return
   (call $closure-obj-reassign/Box#get:value
    (call $~lib/rt/__tmptostack
     (call $~lib/tuple/SmallTuple#__get<closure-obj-reassign/Box>
      (call $~lib/rt/__tmptostack
       (local.get $0)
 ...
 (func $start:closure-obj-reassign
  (global.set $~lib/rt/itcms/threshold
   (i32.shr_u
    (i32.sub
     (i32.shl
   ...
   (i32.eqz
    (i32.eq
     (block (result i32)
      ...
      (call $closure-obj-reassign/outer)
     )
     (i32.const 42)
    )
   )
 ...
 (func $~lib/rt/__visit_members (param $0 i32) (param $1 i32)
  (block $invalid
   (block $~lib/function/Function<%28%29=>void>
    (block $closure-obj-reassign/Box
     (block $~lib/tuple/SmallTuple
      (block $~lib/arraybuffer/ArrayBufferView
       (block $~lib/string/String
        (block $~lib/arraybuffer/ArrayBuffer
         (block $~lib/object/Object
          (br_table $~lib/object/Object $~lib/arraybuffer/ArrayBuffer $~lib/string/String $~lib/arraybuffer/ArrayBufferView $~lib/tuple/SmallTuple $closure-obj-reassign/Box $~lib/function/Function<%28%29=>void> $invalid
           (i32.load
            (i32.sub
             (local.get $0)
             (i32.const 8)
 ...
 (func $~start
  (call $start:closure-obj-reassign)
 )
)
