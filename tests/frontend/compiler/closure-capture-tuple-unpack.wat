(module
 ...
 (global $closure-capture-tuple-unpack/captured (mut i32) (i32.const 0))
 ...
 (data $8 (i32.const 412) "\\\00\00\00\00\00\00\00\00\00\00\00\02\00\00\00>\00\00\00c\00l\00o\00s\00u\00r\00e\00-\00c\00a\00p\00t\00u\00r\00e\00-\00t\00u\00p\00l\00e\00-\00u\00n\00p\00a\00c\00k\00.\00t\00s\00\00\00\00\00\00\00\00\00\00\00\00\00\00\00")
 ...
 (table $0 2 2 funcref)
 (elem $0 (i32.const 1) $closure-capture-tuple-unpack/outer~inner)
 (export "outer" (func $closure-capture-tuple-unpack/outer))
 ...
 (func $closure-capture-tuple-unpack/outer~inner (result i32)
  (local $0 i32)
  (local.set $0
 ...
 (func $closure-capture-tuple-unpack/outer
  (local $0 i32)
  (local $1 i32)
  (local $2 i32)
  (local $left i32)
  ...
  (global.set $closure-capture-tuple-unpack/captured
   (local.get $inner)
  )
 )
 (func $start:closure-capture-tuple-unpack
  (local $0 i32)
  (local $1 i32)
  (global.set $~lib/rt/itcms/threshold
   (i32.shr_u
  ...
  (block
   ...
   (call $closure-capture-tuple-unpack/outer)
  )
  (if
   (i32.eqz
    (i32.ne
     (global.get $closure-capture-tuple-unpack/captured)
     (i32.const 0)
    )
   )
   (then
 ...
 (func $~start
  (call $start:closure-capture-tuple-unpack)
 )
)
