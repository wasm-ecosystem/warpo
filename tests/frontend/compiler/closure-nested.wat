(module
 ...
 (data $8 (i32.const 412) "<\00\00\00\00\00\00\00\00\00\00\00\02\00\00\00\"\00\00\00c\00l\00o\00s\00u\00r\00e\00-\00n\00e\00s\00t\00e\00d\00.\00t\00s\00\00\00\00\00\00\00\00\00\00\00")
 (data $9 (i32.const 480) "\06\00\00\00 \00\00\00 \00\00\00 \00\00\00\00\00\00\00\00\00\00\00\00\00\00\00")
 (table $0 3 3 funcref)
 (elem $0 (i32.const 1) $closure-nested/outer~middle~inner $closure-nested/outer~middle)
 (export "outer" (func $closure-nested/outer))
 ...
 (func $closure-nested/outer~middle~inner (result i32)
  (local $0 i32)
  (local.set $0
 ...
 (func $closure-nested/outer~middle (result i32)
  (local $0 i32)
  (local $y i32)
  (local $inner i32)
  (local.set $0
 ...
 (func $closure-nested/outer (param $a i32) (result i32)
  (local $1 i32)
  (local $x i32)
  (local $middle i32)
  (local.set $1
