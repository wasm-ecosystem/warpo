(module
 ...
 (data $8 (i32.const 412) "<\00\00\00\00\00\00\00\00\00\00\00\02\00\00\00*\00\00\00t\00u\00p\00l\00e\00-\00u\00n\00p\00a\00c\00k\00-\00c\00o\00n\00s\00t\00.\00t\00s\00\00\00")
 (data $9 (i32.const 480) "\06\00\00\00 \00\00\00 \00\00\00 \00\00\00\00\00\00\00\00\00\00\00 \00\00\00")
 (table $0 1 1 funcref)
 (elem $0 (i32.const 1))
 (export "_start" (func $tuple-unpack-const/_start))
 ...
 (func $tuple-unpack-const/Box#set:value (param $this i32) (param $value i32)
  (i32.store
   (local.get $this)
   (local.get $value)
  )
 )
 (func $tuple-unpack-const/Box#constructor (param $this i32) (param $value i32) (result i32)
  (nop)
  (call $tuple-unpack-const/Box#set:value
 ...
 (func $~lib/tuple/SmallTuple#__set<tuple-unpack-const/Box> (param $this i32) (param $offset i32) (param $value i32)
  (local $elementPtr i32)
  (local.set $elementPtr
   (i32.add
    (local.get $this)
 ...
 (func $~lib/tuple/SmallTuple#__get<tuple-unpack-const/Box> (param $this i32) (param $offset i32) (result i32)
  (local $elementPtr i32)
  (local.set $elementPtr
   (i32.add
    (local.get $this)
 ...
 (func $tuple-unpack-const/Box#get:value (param $this i32) (result i32)
  (i32.load
   (local.get $this)
  )
 )
 (func $tuple-unpack-const/_start (result i32)
  (local $0 i32)
  (local $1 i32)
  (local $a i32)
  (local $b i32)
  ...
  (local.set $5
   (call $~lib/rt/__localtostack
    (block (result i32)
     ...
     (call $~lib/tuple/SmallTuple#__set<tuple-unpack-const/Box>
      (call $~lib/rt/__tmptostack
       (local.get $4)
      )
      (i32.const 4)
      (call $~lib/rt/__tmptostack
       (call $tuple-unpack-const/Box#constructor
        (call $~lib/rt/__tmptostack
         (call $~lib/rt/itcms/__new
          (i32.const 4)
          (i32.const 5)
  ...
  (local.set $box
   (call $~lib/rt/__localtostack
    (call $~lib/tuple/SmallTuple#__get<tuple-unpack-const/Box>
     (call $~lib/rt/__tmptostack
      (local.get $5)
     )
     (i32.const 4)
  ...
  (if
   (i32.eqz
    (i32.eq
     (call $tuple-unpack-const/Box#get:value
      (call $~lib/rt/__tmptostack
       (local.get $box)
      )
     )
 ...
 (func $start:tuple-unpack-const
  ...
  (if
   (i32.eqz
    (i32.eq
     (call $tuple-unpack-const/_start)
     (i32.const 100)
    )
   )
   (then
 ...
 (func $~lib/rt/__visit_members (param $0 i32) (param $1 i32)
  (block $invalid
   (block $tuple-unpack-const/Box
    (block $~lib/tuple/SmallTuple
     (block $~lib/arraybuffer/ArrayBufferView
      (block $~lib/string/String
       (block $~lib/arraybuffer/ArrayBuffer
        (block $~lib/object/Object
         (br_table $~lib/object/Object $~lib/arraybuffer/ArrayBuffer $~lib/string/String $~lib/arraybuffer/ArrayBufferView $~lib/tuple/SmallTuple $tuple-unpack-const/Box $invalid
          (i32.load
           (i32.sub
            (local.get $0)
            (i32.const 8)
