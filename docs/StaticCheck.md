### Run klocwork locally

1. Install klocwork check helper

https://atc-github.azure.cloud.bmw/CDCFW/klocwork_check.git

2. run
   x86_64

```shell
cmake -G "Unix Makefiles" -DCMAKE_BUILD_TYPE=Release -B build_klocwork -S .
python3 -m klocwork_check -m "./build_klocwork/Makefile" -i "./src"
```

aarch64

```shell
cmake -G "Unix Makefiles" -DCMAKE_C_COMPILER=aarch64-linux-gnu-gcc -DCMAKE_CXX_COMPILER=aarch64-linux-gnu-g++  -DCMAKE_BUILD_TYPE=Release -B build_klocwork_arm -S .
python3 -m klocwork_check -m "./build_klocwork_arm/Makefile" -i "./src"
```

tricore

```shell
cmake -G "Unix Makefiles" -DCMAKE_C_COMPILER=tricore-elf-gcc -DCMAKE_CXX_COMPILER=tricore-elf-g++  -DCMAKE_BUILD_TYPE=Release -B build_klocwork_tricore -S .
python3 -m klocwork_check -m "./build_klocwork_tricore/Makefile" -i "./src"
```
