...
- Shadow Stack Integration: Dynamically tracks GC roots on the stack via a ["shadow stack"](/en/using_runtime/shadow_stack), eliminating the need for complex stack maps.
