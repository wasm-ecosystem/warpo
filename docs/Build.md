...
This section will assume you are in BMW office and have connection to qcc license server
For starter of QNX and QCC, it's recommended to read:
https://atc.bmwgroup.net/confluence/display/CDCDEV/Getting+start+with+QNX
add following lines to ~/.profile

```shell
export QNX_HOST=/qcc_install_path/qnx_base_r801/host/linux/x86_64
export QNX_TARGET=/qcc_install_path/qnx_base_r801/target/qnx7
export QNXLM_LICENSE_FILE=9914@smuc11822.bmwgroup.net
export QNX_SHARED_LICENSE_FILE=/qcc_install_path/qnx_base_r801/license/licenses
```

replace qcc_install_path with your actual qcc install location
reload profile:
...
```shell
build --action_env=QNX_HOST=/qcc_install_path/qnx_base_r801/host/linux/x86_64
build --action_env=QNX_TARGET=/qcc_install_path/qnx_base_r801/target/qnx7
build --action_env=QNXLM_LICENSE_FILE=9914@smuc11822.bmwgroup.net
build --action_env=QNX_SHARED_LICENSE_FILE=/qcc_install_path/license/licenses
```
