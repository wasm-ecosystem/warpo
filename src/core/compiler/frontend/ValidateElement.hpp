...
public:
  ...
  ///
  /// @brief Get machineType from inner validate type
  /// @return return dummy machineType::INVALID if inner validate type is not number(F64, F32, I64, I32)
  inline MachineType getWasmNumberType() const VB_NOEXCEPT {
    switch (validateType_) {
    case ValidateType::F64:
      return MachineType::F64;
    case ValidateType::F32:
      return MachineType::F32;
    case ValidateType::I64:
      return MachineType::I64;
    case ValidateType::I32:
      return MachineType::I32;
    default:
      return MachineType::INVALID; // dummy return
    }
  }
  ///
  ...
  inline bool isNumber() const VB_NOEXCEPT {
    return validateType_ <= ValidateType::ANY;
  }
  ///
