...
async function buildWithASC({ sources, outputWASM, userDefinedFlags }) {
...
async function buildWithWARPO({ sources, outputWASM, userDefinedFlags }) {
    let warpoArgv = [
        ...sources,
        "-o",
        outputWASM,
...
export async function compileImpl(option, useWarpo) {
