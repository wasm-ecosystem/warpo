...
RuntimeError::operator const char *() const VB_NOEXCEPT {
  ...
  case (Code::evaluateInstructionAndInsertSkips__Stack_frame_underflow): {
    return "evaluateInstructionAndInsertSkips: Stack frame underflow";
  }
  case (Code::condenseValentBlockCore__Stack_frame_underflow): {
    return "condenseValentBlockCore: Stack frame underflow";
  }
  case (Code::findBaseOfValentBlock__Stack_frame_underflow): {
    return "findBaseOfValentBlock: Stack frame underflow";
  }
  case (Code::validateAndDropValentBlock__Stack_frame_underflow): {
    return "validateAndDropValentBlock: Stack frame underflow";
  }
  case (Code::findNextHigherElementOnStack__overflow): {
    return "findNextHigherElementOnStack__overflow";
  }
  case (Code::Maximum_number_of_bytes_written): {
    return "Maximum number of bytes written";
  }
  case (Code::No_element_on_stack): {
  ...
  case (Code::Else_block_must_terminate_an_if_block): {
    return "Else block must terminate an if block";
  }
  case (Code::Wrong_number_of_elements_at_block_end): {
    return "Wrong number of elements at block end";
  }
  case (Code::Type_mismatch_for_if_true_and_false_branches): {
    return "Type mismatch for if true and false branches";
  }
  case (Code::Wrong_number_of_elements_at_function_end): {
    return "Wrong number of elements at function end";
  }
