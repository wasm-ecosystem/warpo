...
public:
  ...
  enum class Code : uint16_t {
    ...
    Wrong_type,
    evaluateInstructionAndInsertSkips__Stack_frame_underflow,
    condenseValentBlockCore__Stack_frame_underflow,
    findBaseOfValentBlock__Stack_frame_underflow,
    validateAndDropValentBlock__Stack_frame_underflow,
    findNextHigherElementOnStack__overflow,
    ...
    Else_block_must_terminate_an_if_block,
    Wrong_number_of_elements_at_block_end,
    Type_mismatch_for_if_true_and_false_branches,
    Wrong_number_of_elements_at_function_end,
