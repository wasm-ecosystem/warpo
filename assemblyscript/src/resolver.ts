    ...
    if (instance.isAny(CommonFlags.Get | CommonFlags.Set)) {
      ...
      if (boundPrototype) {
        ...
        if (boundFuncPrototype.is(CommonFlags.Generic) == instance.is(CommonFlags.Generic)) {
          ret = this.resolveFunction(boundFuncPrototype, instance.typeArguments);
        }
      }
    }
    return ret;
          ...
          case ElementKind.PropertyPrototype: {
            ...
            if (boundPrototype.isField) {
              ...
              if (boundInstance) {
                ...
                mir.addFieldDeclaration(instance, memberName, fieldType, boundInstance.memoryOffset, !needsLayout);
