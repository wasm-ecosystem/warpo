...
https://atc-github.azure.cloud.bmw/CDCFW/wasm-compiler-benchmark


### 5. Run bench
```
python scripts/benchmark/run_bench.py -i ../wasm-compiler-benchmark -x ./build_bench/bin/vb_bench
```
